import { a0 as useTheme, a1 as useMediaQuery, aG as useQueryClient, $ as useLocation, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, cZ as ShieldIcon, X as Box, aJ as Stack, aj as Typography, aK as Button, aL as DoneAllIcon, ag as alpha, bn as Skeleton, aN as EmptyIcon, cX as parseISO, cb as isToday, c_ as isYesterday, c$ as isThisWeek, bl as format, d0 as DotIcon, am as Chip, aO as formatDistanceToNow, d1 as ExpandIcon, b$ as Collapse, aQ as OpenIcon, bu as CheckIcon, an as Tooltip, af as IconButton, bD as DeleteIcon, aR as InfoIcon, aT as ErrorIcon, aU as CheckCircle, by as WarningIcon, aV as PayIcon, aW as EventIcon, aD as SwapIcon, aC as ScheduleIcon } from './vendor-Dx2XWalh.js';
import { u as useAuth, i as isManager, c as apiRequest, P as PesoIcon } from './main-Bqx8lZf7.js';
...
const TYPE_CONFIG = {
  ...
  shift_trade: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 20 } }), color: "#8B5CF6", bg: "#F5F3FF", label: "Trade" },
  trade_request: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 20 } }), color: "#8B5CF6", bg: "#F5F3FF", label: "Trade" },
  time_off: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(EventIcon, { sx: { fontSize: 20 } }), color: "#F59E0B", bg: "#FFFBEB", label: "Time Off" },
  time_off_approved: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 20 } }), color: "#10B981", bg: "#ECFDF5", label: "Approved" },
  ...
  approval: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 20 } }), color: "#10B981", bg: "#ECFDF5", label: "Approved" },
  ...
  success: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 20 } }), color: "#10B981", bg: "#ECFDF5", label: "Success" },
