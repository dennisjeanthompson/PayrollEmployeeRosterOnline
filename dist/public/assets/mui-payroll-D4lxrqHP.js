const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-kM9VPQZA.js","assets/vendor-Dx2XWalh.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-BtLCmaKW.js","assets/main-Bqx8lZf7.js","assets/main-CUWWAj6L.css","assets/button-7nJ87TEV.js","assets/use-toast-3gRm_Kje.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, bk as motion, ag as alpha, aJ as Stack, aj as Typography, an as Tooltip, af as IconButton, cP as RefreshIcon, cQ as LinearProgress, bp as Grid, bv as Receipt, cp as AccessTime, b7 as Paper, al as Avatar, bn as Skeleton, am as Chip, c4 as Tabs, c5 as Tab, ad as HistoryIcon, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, a3 as CalendarIcon, bl as format, cX as parseISO, aS as AdjustmentIcon, aU as CheckCircle, cY as DescriptionIcon, ae as DownloadIcon, bm as Divider, aK as Button, T as __vitePreload } from './vendor-Dx2XWalh.js';
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-Bqx8lZf7.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-kM9VPQZA.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
