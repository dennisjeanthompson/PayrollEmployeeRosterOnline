const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-C0ILE-Xy.js","assets/vendor-BZHHI3oX.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-DNATCumW.js","assets/main-ktqtsBlx.js","assets/main-BqNa2CEM.css","assets/button-CZskdHga.js","assets/use-toast-CI81V-xA.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, bk as motion, ag as alpha, aJ as Stack, aj as Typography, an as Tooltip, af as IconButton, cP as RefreshIcon, cQ as LinearProgress, bq as Grid, bv as TaxIcon, cp as AccessTime, b7 as Paper, al as Avatar, bn as Skeleton, am as Chip, c4 as Tabs, c5 as Tab, ad as HistoryIcon, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, a3 as CalendarIcon, bl as format, cX as parseISO, aS as AdjustmentIcon, aU as CheckCircle, cY as DescriptionIcon, ae as DownloadIcon, bm as Divider, aK as Button, T as __vitePreload } from './vendor-BZHHI3oX.js';
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-ktqtsBlx.js';
import { u as useRealtime } from './use-realtime-Cix389so.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-C0ILE-Xy.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
