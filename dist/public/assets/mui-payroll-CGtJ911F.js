const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-ByFejg3Z.js","assets/vendor-Br1LjuIs.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-D7MHW5kK.js","assets/main-DtyG-vBp.js","assets/main-CUWWAj6L.css","assets/button-C-pnwCIa.js","assets/use-toast-D9VL1-uB.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, bk as motion, ag as alpha, aJ as Stack, aj as Typography, an as Tooltip, af as IconButton, cP as RefreshIcon, cQ as LinearProgress, bq as Grid, bv as TaxIcon, cp as AccessTime, b7 as Paper, al as Avatar, bn as Skeleton, am as Chip, c4 as Tabs, c5 as Tab, ad as HistoryIcon, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, a3 as CalendarIcon, bl as format, cX as parseISO, aS as AdjustmentIcon, aU as CheckCircle, cY as DescriptionIcon, ae as DownloadIcon, bm as Divider, aK as Button, T as __vitePreload } from './vendor-Br1LjuIs.js';
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-DtyG-vBp.js';
import { u as useRealtime } from './use-realtime-VE15-UZW.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-ByFejg3Z.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
...
function MuiPayroll() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3, minHeight: "100vh", bgcolor: "background.default" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { container: true, spacing: 2, sx: { mb: 3 }, children: [
      ...
      { label: "Latest Net Pay", value: formatCurrency(lastPayAmount), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TaxIcon, { fontSize: "small" }), color: theme.palette.info.main },
