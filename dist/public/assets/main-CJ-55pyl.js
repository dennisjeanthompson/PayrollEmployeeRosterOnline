...
const MuiDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-dashboard-Bj_R1irx.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0));
const MuiEmployees = reactExports.lazy(() => __vitePreload(() => import('./mui-employees-5je4U_RB.js'),true              ?__vite__mapDeps([5,1,2,6,3,4,7,8,9,10,11]):void 0));
const ScheduleV2 = reactExports.lazy(() => __vitePreload(() => import('./schedule-v2-CUoWnonZ.js'),true              ?__vite__mapDeps([12,1,2,6]):void 0));
const MuiPayroll = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-Bkhr2Owo.js'),true              ?__vite__mapDeps([13,1,2,6,14]):void 0));
const MuiNotifications = reactExports.lazy(() => __vitePreload(() => import('./mui-notifications-CaUeUEMS.js'),true              ?__vite__mapDeps([15,1,2,3,6]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-shift-trading-kh604xPa.js'),true              ?__vite__mapDeps([16,1,2,3,6,17]):void 0));
const MuiBranches = reactExports.lazy(() => __vitePreload(() => import('./mui-branches-CMQrv4bh.js'),true              ?__vite__mapDeps([18,1,2,3]):void 0));
const MuiReports = reactExports.lazy(() => __vitePreload(() => import('./mui-reports-B8scO-xG.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0));
const MuiAnalytics = reactExports.lazy(() => __vitePreload(() => import('./mui-analytics-ORVhQYEL.js'),true              ?__vite__mapDeps([20,1,2,6,21]):void 0));
const MuiLogin = reactExports.lazy(() => __vitePreload(() => import('./mui-login-lJSn5jYF.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-time-off-D7I8RERd.js'),true              ?__vite__mapDeps([23,1,2,3,6]):void 0));
const MuiDeductionSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-deduction-settings-Depq4R9t.js'),true              ?__vite__mapDeps([24,1,2,6,3]):void 0));
const MuiPayrollManagement = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-management-BJdc1fAe.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,14,11,8]):void 0));
const MuiAdminDeductionRates = reactExports.lazy(() => __vitePreload(() => import('./mui-admin-deduction-rates-BLFkYz5L.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0));
const MuiAuditLogs = reactExports.lazy(() => __vitePreload(() => import('./mui-audit-logs-Da8OltYy.js'),true              ?__vite__mapDeps([28,1,2,6]):void 0));
const MuiHolidayCalendar = reactExports.lazy(() => __vitePreload(() => import('./mui-holiday-calendar-Bby76L4R.js'),true              ?__vite__mapDeps([29,1,2,6,3]):void 0));
const MuiComplianceDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-compliance-dashboard-CxJo8adL.js'),true              ?__vite__mapDeps([30,1,2]):void 0));
const MuiProfileSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-profile-settings-CJSzWP67.js'),true              ?__vite__mapDeps([31,1,2,6,7,8,9,3]):void 0));
const MuiCompanySettings = reactExports.lazy(() => __vitePreload(() => import('./mui-company-settings-Cth75lc7.js'),true              ?__vite__mapDeps([32,1,2,6,3,9]):void 0));
const Mui13thMonth = reactExports.lazy(() => __vitePreload(() => import('./mui-13th-month-Dn5Fiuly.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0));
const MuiLeaveCredits = reactExports.lazy(() => __vitePreload(() => import('./mui-leave-credits-DqnrtUol.js'),true              ?__vite__mapDeps([34,1,2,6,3,4]):void 0));
const MuiRequests = reactExports.lazy(() => __vitePreload(() => import('./mui-requests-D5or3TCZ.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0));
const MobileRequests = reactExports.lazy(() => __vitePreload(() => import('./mobile-requests-9t9VsQvP.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0));
const MobileMore = reactExports.lazy(() => __vitePreload(() => import('./mobile-more-Ccb7Rd1Q.js'),true              ?__vite__mapDeps([37,1,2]):void 0));
const Setup = reactExports.lazy(() => __vitePreload(() => import('./setup-By6Cp1XT.js'),true              ?__vite__mapDeps([38,1,2,10,8,3]):void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import('./not-found-BFgUvRW6.js'),true              ?__vite__mapDeps([39,1,2,8]):void 0));
const prefetchRoutes = () => {
  const idleCallback = typeof requestIdleCallback !== "undefined" ? requestIdleCallback : setTimeout;
  idleCallback(() => {
    __vitePreload(() => import('./mui-dashboard-Bj_R1irx.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0);
    __vitePreload(() => import('./schedule-v2-CUoWnonZ.js'),true              ?__vite__mapDeps([12,1,2,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-employees-5je4U_RB.js'),true              ?__vite__mapDeps([5,1,2,6,3,4,7,8,9,10,11]):void 0);
    __vitePreload(() => import('./mui-payroll-management-BJdc1fAe.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,14,11,8]):void 0);
    __vitePreload(() => import('./mui-notifications-CaUeUEMS.js'),true              ?__vite__mapDeps([15,1,2,3,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-reports-B8scO-xG.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0);
    __vitePreload(() => import('./mui-requests-D5or3TCZ.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0);
    __vitePreload(() => import('./mui-profile-settings-CJSzWP67.js'),true              ?__vite__mapDeps([31,1,2,6,7,8,9,3]):void 0);
    __vitePreload(() => import('./mobile-requests-9t9VsQvP.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0);
  });
};
