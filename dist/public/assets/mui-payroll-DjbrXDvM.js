const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-BDc4D8A4.js","assets/vendor-CSPGr19o.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-Bk2Am-L5.js","assets/main-BPmoyhc1.js","assets/main-xPCl3CQX.css","assets/button-CsUxrk98.js","assets/use-toast-fxvX43TA.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, bk as motion, ag as alpha, aJ as Stack, aj as Typography, an as Tooltip, af as IconButton, cO as RefreshIcon, cP as LinearProgress, br as Grid, bs as AccessTime, a7 as TrendingUpIcon, bq as TaxIcon, b7 as Paper, al as Avatar, bn as Skeleton, am as Chip, c5 as Tabs, c6 as Tab, ad as HistoryIcon, cQ as TableContainer, cR as Table, cS as TableHead, cT as TableRow, cU as TableCell, cV as TableBody, a3 as CalendarIcon, bl as format, cW as parseISO, aS as AdjustmentIcon, aU as CheckCircle, cX as DescriptionIcon, ae as DownloadIcon, bm as Divider, aK as Button, T as __vitePreload } from './vendor-CSPGr19o.js';
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-BPmoyhc1.js';
import { u as useRealtime } from './use-realtime-OpF-eZ2D.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-BDc4D8A4.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
