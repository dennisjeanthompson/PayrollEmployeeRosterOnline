import { a0 as useTheme, $ as useLocation, ax as useQuery, Q as jsxRuntimeExports, c8 as SecurityIcon, c9 as HealthIcon, ca as HomeIcon, bv as TaxIcon, ab as VerifiedIcon, by as WarningIcon, X as Box, aM as CircularProgress, ag as alpha, aj as Typography, am as Chip, aU as CheckCircle, aT as ErrorIcon, bs as Card, bt as CardContent, aJ as Stack, cQ as LinearProgress, aK as Button, cP as RefreshIcon, r as reactExports, aQ as OpenIcon, ar as List, as as ListItem, au as ListItemIcon, aw as ListItemText, bm as Divider, bB as Alert } from './vendor-BZHHI3oX.js';
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: { xs: 2, md: 4 } }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 2, mb: 4 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Chip,
        {
          icon: score >= 80 ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) : score >= 50 ? /* @__PURE__ */ jsxRuntimeExports.jsx(WarningIcon, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorIcon, {}),
