const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HolidayCalendarView-BcpKeITR.js","assets/vendor-Dx2XWalh.js","assets/vendor-Bi9pq-j3.css","assets/vendor-calendar-BJf_YqP7.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, aG as useQueryClient, r as reactExports, bl as format, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, an as Tooltip, X as Box, ag as alpha, aj as Typography, aM as CircularProgress, a3 as CalendarIcon, aJ as Stack, bE as TextField, b2 as MenuItem, aK as Button, cP as RefreshIcon, bt as AddIcon, cQ as LinearProgress, br as Card, bs as CardContent, c4 as Tabs, c5 as Tab, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, am as Chip, aU as CheckCircle, cn as Block, af as IconButton, bV as EditIcon, bD as DeleteIcon, bz as CloseIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, cC as LocalizationProvider, cD as AdapterDateFns, cF as DatePicker, bF as FormControlLabel, c2 as Switch, bH as DialogActions, bB as Alert, T as __vitePreload } from './vendor-Dx2XWalh.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
import { u as useAuth, c as apiRequest } from './main-Bqx8lZf7.js';
import { u as useToast } from './use-toast-3gRm_Kje.js';

const HolidayCalendarView = reactExports.lazy(() => __vitePreload(() => import('./HolidayCalendarView-BcpKeITR.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0));
const holidayTypes = [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, flexWrap: "wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField,
              {
                ...
                sx: { minWidth: 100 },
                children: [(/* @__PURE__ */ new Date()).getFullYear() - 2, (/* @__PURE__ */ new Date()).getFullYear() - 1, (/* @__PURE__ */ new Date()).getFullYear(), (/* @__PURE__ */ new Date()).getFullYear() + 1, (/* @__PURE__ */ new Date()).getFullYear() + 2].map((year) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: year, children: year }, year))
              }
            ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: sortedHolidays.map((holiday) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { hover: true, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Chip,
            {
              icon: holiday.workAllowed ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Block, {}),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 0.5, sx: { mb: 2 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      size: "small",
                      icon: detailHoliday.workAllowed ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Block, {}),
