const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mui-dashboard-BgA6YGBl.js","assets/vendor-Br1LjuIs.js","assets/vendor-Bi9pq-j3.css","assets/use-toast-D9VL1-uB.js","assets/mui-branches-w2v9Z_ma.js","assets/mui-employees-FIbGQtk2.js","assets/use-realtime-CV_qTf0h.js","assets/cards-CK-9kUtF.js","assets/ProfilePhotoUpload-trUjj3cM.js","assets/button-CG4jjFuq.js","assets/cloudinary-BguyRvQT.js","assets/card-C4CSfYqm.js","assets/dialog-B8vDTdYq.js","assets/schedule-v2-BfF-rYOs.js","assets/mui-payroll-BitFFbZO.js","assets/payroll-dates-BmATSNY8.js","assets/mui-notifications-Cq5HD5Td.js","assets/mui-shift-trading-7MBwLJ3x.js","assets/vendor-calendar-thdinLa5.js","assets/mui-reports-D5Dknhs6.js","assets/mui-analytics-B4PECi2m.js","assets/vendor-charts-BQ-9iQzb.js","assets/mui-login-Dd7pxPMs.js","assets/mui-time-off-4Zm2NHwV.js","assets/mui-deduction-settings-BHrG1lsy.js","assets/mui-payroll-management-BgaYheS3.js","assets/payslip-preview-CXZ0NLkh.js","assets/mui-admin-deduction-rates-BA9nz56h.js","assets/mui-audit-logs-BLAWpXWM.js","assets/mui-holiday-calendar-CGkKx5WZ.js","assets/mui-compliance-dashboard-CvIE17s0.js","assets/mui-profile-settings-6ZvcwlJD.js","assets/mui-company-settings-BrN1hmY2.js","assets/mui-13th-month-CWEgCRKt.js","assets/mui-leave-credits-Dp_3e8Dw.js","assets/mui-requests-CoNQ5eRA.js","assets/mobile-requests-Bmj6syas.js","assets/mobile-more-DwlqENvP.js","assets/setup-BUbM0NDI.js","assets/not-found-CsX_0oPe.js"])))=>i.map(i=>d[i]);
import { a as React, Q as jsxRuntimeExports, S as QueryClient, r as reactExports, T as __vitePreload, U as createTheme, V as ThemeProvider$1, W as CssBaseline, X as Box, Y as SvgIcon, Z as twMerge, o as clsx, $ as useLocation, a0 as useTheme$1, a1 as useMediaQuery, a2 as DashboardIcon, a3 as CalendarIcon, a4 as NotificationsIcon, a5 as PeopleIcon, a6 as AssignmentIcon, a7 as TrendingUpIcon, a8 as StoreIcon, a9 as BusinessIcon, aa as ProfileIcon, ab as VerifiedIcon, ac as SettingsIcon, ad as HistoryIcon, ae as DownloadIcon, af as IconButton, ag as alpha, ah as ChevronRightIcon, ai as ChevronLeftIcon, aj as Typography, ak as AutoAwesome, al as Avatar, am as Chip, an as Tooltip, ao as LogoutIcon, ap as SwipeableDrawer, aq as Drawer, ar as List, as as ListItem, at as ListItemButton, au as ListItemIcon, av as Badge, aw as ListItemText, ax as useQuery, ay as Dialog, az as Search$1, aA as InputBase, aB as ArrowIcon, aC as ScheduleIcon, aD as SwapIcon, aE as EventIcon, aF as ReportIcon, aG as useQueryClient, aH as useMutation, aI as Menu, aJ as Stack, aK as Button, aL as DoneAllIcon, aM as CircularProgress, aN as EmptyIcon, aO as formatDistanceToNow, aP as Link, aQ as OpenIcon, aR as InfoIcon, aS as AdjustmentIcon, aT as ErrorIcon, aU as CheckCircle, aV as PayIcon, aW as EventIcon$1, aX as styled, aY as AppBar, aZ as Toolbar, a_ as MenuIcon, a$ as KeyboardIcon, b0 as FormControl, b1 as Select, b2 as MenuItem, b3 as LocationIcon, b4 as Snackbar, b5 as SunIcon, b6 as MoonIcon, b7 as Paper, b8 as BottomNavigation, b9 as BottomNavigationAction, ba as HomeIcon, bb as ScheduleIcon$1, bc as PayrollIcon, bd as MenuIcon$1, be as QueryClientProvider, bf as Switch, bg as Route, bh as Redirect, bi as Lt, bj as clientExports } from './vendor-Br1LjuIs.js';
...
function CommandPalette({ open, onClose }) {
  ...
  const pages = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { fontSize: "small" }),
...
const TYPE_STYLE = {
  ...
  shift_trade: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 16 } }), color: "#8B5CF6", gradient: "linear-gradient(135deg, #8B5CF6, #6D28D9)" },
  trade_request: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 16 } }), color: "#8B5CF6", gradient: "linear-gradient(135deg, #8B5CF6, #6D28D9)" },
  ...
  time_off_approved: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }), color: "#10B981", gradient: "linear-gradient(135deg, #10B981, #059669)" },
  ...
  approval: { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }), color: "#10B981", gradient: "linear-gradient(135deg, #10B981, #059669)" },
...
const MuiDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-dashboard-BgA6YGBl.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0));
const MuiEmployees = reactExports.lazy(() => __vitePreload(() => import('./mui-employees-FIbGQtk2.js'),true              ?__vite__mapDeps([5,1,2,6,3,7,8,9,10,11,12]):void 0));
const ScheduleV2 = reactExports.lazy(() => __vitePreload(() => import('./schedule-v2-BfF-rYOs.js'),true              ?__vite__mapDeps([13,1,2,6]):void 0));
const MuiPayroll = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-BitFFbZO.js'),true              ?__vite__mapDeps([14,1,2,6,15]):void 0));
const MuiNotifications = reactExports.lazy(() => __vitePreload(() => import('./mui-notifications-Cq5HD5Td.js'),true              ?__vite__mapDeps([16,1,2,3,6]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-shift-trading-7MBwLJ3x.js'),true              ?__vite__mapDeps([17,1,2,3,6,18]):void 0));
const MuiBranches = reactExports.lazy(() => __vitePreload(() => import('./mui-branches-w2v9Z_ma.js'),true              ?__vite__mapDeps([4,1,2,3]):void 0));
const MuiReports = reactExports.lazy(() => __vitePreload(() => import('./mui-reports-D5Dknhs6.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0));
const MuiAnalytics = reactExports.lazy(() => __vitePreload(() => import('./mui-analytics-B4PECi2m.js'),true              ?__vite__mapDeps([20,1,2,6,21]):void 0));
const MuiLogin = reactExports.lazy(() => __vitePreload(() => import('./mui-login-Dd7pxPMs.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-time-off-4Zm2NHwV.js'),true              ?__vite__mapDeps([23,1,2,3,6]):void 0));
const MuiDeductionSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-deduction-settings-BHrG1lsy.js'),true              ?__vite__mapDeps([24,1,2,6,3]):void 0));
const MuiPayrollManagement = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-management-BgaYheS3.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,15,12,9]):void 0));
const MuiAdminDeductionRates = reactExports.lazy(() => __vitePreload(() => import('./mui-admin-deduction-rates-BA9nz56h.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0));
const MuiAuditLogs = reactExports.lazy(() => __vitePreload(() => import('./mui-audit-logs-BLAWpXWM.js'),true              ?__vite__mapDeps([28,1,2,6]):void 0));
const MuiHolidayCalendar = reactExports.lazy(() => __vitePreload(() => import('./mui-holiday-calendar-CGkKx5WZ.js'),true              ?__vite__mapDeps([29,1,2,6,3]):void 0));
const MuiComplianceDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-compliance-dashboard-CvIE17s0.js'),true              ?__vite__mapDeps([30,1,2]):void 0));
const MuiProfileSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-profile-settings-6ZvcwlJD.js'),true              ?__vite__mapDeps([31,1,2,6,8,9,10,3]):void 0));
const MuiCompanySettings = reactExports.lazy(() => __vitePreload(() => import('./mui-company-settings-BrN1hmY2.js'),true              ?__vite__mapDeps([32,1,2,6,3,10]):void 0));
const Mui13thMonth = reactExports.lazy(() => __vitePreload(() => import('./mui-13th-month-CWEgCRKt.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0));
const MuiLeaveCredits = reactExports.lazy(() => __vitePreload(() => import('./mui-leave-credits-Dp_3e8Dw.js'),true              ?__vite__mapDeps([34,1,2,6,3,7]):void 0));
const MuiRequests = reactExports.lazy(() => __vitePreload(() => import('./mui-requests-CoNQ5eRA.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0));
const MobileRequests = reactExports.lazy(() => __vitePreload(() => import('./mobile-requests-Bmj6syas.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0));
const MobileMore = reactExports.lazy(() => __vitePreload(() => import('./mobile-more-DwlqENvP.js'),true              ?__vite__mapDeps([37,1,2]):void 0));
const Setup = reactExports.lazy(() => __vitePreload(() => import('./setup-BUbM0NDI.js'),true              ?__vite__mapDeps([38,1,2,11,9,3]):void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import('./not-found-CsX_0oPe.js'),true              ?__vite__mapDeps([39,1,2,9]):void 0));
const prefetchRoutes = () => {
  const idleCallback = typeof requestIdleCallback !== "undefined" ? requestIdleCallback : setTimeout;
  idleCallback(() => {
    __vitePreload(() => import('./mui-dashboard-BgA6YGBl.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0);
    __vitePreload(() => import('./schedule-v2-BfF-rYOs.js'),true              ?__vite__mapDeps([13,1,2,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-employees-FIbGQtk2.js'),true              ?__vite__mapDeps([5,1,2,6,3,7,8,9,10,11,12]):void 0);
    __vitePreload(() => import('./mui-payroll-management-BgaYheS3.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,15,12,9]):void 0);
    __vitePreload(() => import('./mui-notifications-Cq5HD5Td.js'),true              ?__vite__mapDeps([16,1,2,3,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-reports-D5Dknhs6.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0);
    __vitePreload(() => import('./mui-requests-CoNQ5eRA.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0);
    __vitePreload(() => import('./mui-profile-settings-6ZvcwlJD.js'),true              ?__vite__mapDeps([31,1,2,6,8,9,10,3]):void 0);
    __vitePreload(() => import('./mobile-requests-Bmj6syas.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0);
  });
};
...
function DesktopRouter({ authState }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/13th-month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireManagerOrAdmin, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DesktopLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouteLoader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mui13thMonth, {}) }) }) }) }) }),
