const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/sss-contribution-table-C-snIfjk.js","assets/vendor-CSPGr19o.js","assets/vendor-Bi9pq-j3.css"])))=>i.map(i=>d[i]);
import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, aM as CircularProgress, ag as alpha, aj as Typography, aJ as Stack, aK as Button, cO as RefreshIcon, bp as AddIcon, c9 as SecurityIcon, ca as HealthIcon, cb as HomeIcon, bq as TaxIcon, cP as LinearProgress, cj as Accordion, ck as AccordionSummary, am as Chip, cl as ExpandMore, cm as AccordionDetails, cQ as TableContainer, cR as Table, cS as TableHead, cT as TableRow, cU as TableCell, cV as TableBody, an as Tooltip, af as IconButton, bW as EditIcon, bG as DeleteIcon, ay as Dialog, by as DialogTitle, bz as DialogContent, bA as TextField, b2 as MenuItem, bB as DialogActions, T as __vitePreload } from './vendor-CSPGr19o.js';
import { P as PesoIcon, c as apiRequest } from './main-CD-KyDdT.js';
import { u as useToast } from './use-toast-fxvX43TA.js';

const SSSContributionTable = reactExports.lazy(() => __vitePreload(() => import('./sss-contribution-table-C-snIfjk.js'),true              ?__vite__mapDeps([0,1,2]):void 0));
