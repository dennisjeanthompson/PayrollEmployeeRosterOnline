...
⇄ Trade ${trade.status}` : ""}`,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1, minWidth: 0, display: "flex", alignItems: "center", height: "100%", gap: 0.5 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { component: "span", sx: { flex: 1, minWidth: 0, textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 0.5 }, children: [
                ...
                "-",
                endStr,
                isOvertime && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Pushes employee >48h (OT)", arrow: true, placement: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { width: 6, height: 6, borderRadius: "50%", bgcolor: "#F97316", flexShrink: 0, boxShadow: "0 0 0 1px #FFF" } }) })
              ] })
            ] })
          }
        ),
...
function RequestsPanel({
  ...
  const scheduleAlerts = React.useMemo(() => {
    ...
    Object.keys(shiftsByEmp).forEach((userId) => {
      ...
      const daysWorked = new Set(empShifts.map((s) => safeFormat$1(s.startTime, "yyyy-MM-dd")));
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2.5, sx: { mt: 1 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField,
              {
                ...
                InputProps: {
                  endAdornment: /* @__PURE__ */ jsxRuntimeExports.jsx(InputAdornment, { position: "end", children: adjType === "late" || adjType === "undertime" || adjType === "overtime" ? "mins" : adjType === "absent" ? "days" : "hrs" })
                },
                helperText: adjType === "late" || adjType === "undertime" || adjType === "overtime" ? `Use minutes for ${adjType === "overtime" ? "overtime" : "tardiness or undertime"} from the logbook.` : adjType === "absent" ? "Use days for a full-day absence entry." : "Use hours for legacy logs."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField,
              ...
              try {
                ...
                for (const res of results) {
                  ...
                  if (bulkDeleteState.employeeId !== "all") {
                    items = items.filter((x) => String(x.userId || x.employeeId) === String(bulkDeleteState.employeeId));
                  }
                  if (res.type === "shifts") {
                    for (const s of items) {
                      promises.push(
                        apiRequest("DELETE", `/api/shifts/${s.id}`, { deletionReason: bulkDeleteState.deletionReason }).then(() => {
                          deletedShifts++;
                        })
                      );
                    }
                    ...
                    for (const l of items) {
                      promises.push(
                        apiRequest("DELETE", `/api/adjustment-logs/${l.id}`, { deletionReason: bulkDeleteState.deletionReason }).then(() => {
                          deletedLogs++;
                        })
                      );
                    }
                ...
                if (failedCount > 0) {
                  y.warning(`Deleted ${msg || "0 items"}, but ${failedCount} items failed.`);
                } else {
