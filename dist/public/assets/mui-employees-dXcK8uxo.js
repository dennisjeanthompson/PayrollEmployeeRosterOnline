import { r as reactExports, Q as jsxRuntimeExports, ay as Dialog, bx as DialogTitle, by as WarningIcon, aj as Typography, af as IconButton, bz as CloseIcon, bA as DialogContent, X as Box, bB as Alert, aJ as Stack, am as Chip, bm as Divider, bC as PersonOffIcon, ae as DownloadIcon, bD as DeleteIcon, aT as ErrorIcon, bE as TextField, bF as FormControlLabel, bG as Checkbox, bH as DialogActions, aK as Button, aM as CircularProgress, bI as cva, bJ as LoaderCircle, bK as FileUp, bL as Eye, bM as Download, bN as Trash2, bO as FileText, bP as y, bQ as Image, a0 as useTheme, aG as useQueryClient, $ as useLocation, bl as format, bR as startOfMonth, bS as endOfMonth, ax as useQuery, aH as useMutation, al as Avatar, aU as CheckCircle, bT as CancelIcon, an as Tooltip, bU as Visibility, bV as EditIcon, bv as Receipt, bW as VisibilityOff, b7 as Paper, ai as ChevronLeftIcon, bX as subMonths, a3 as CalendarIcon, ah as ChevronRightIcon, bY as addMonths, bt as AddIcon, bp as Grid, bZ as InputAdornment, az as Search, b0 as FormControl, b_ as InputLabel, b1 as Select, b2 as MenuItem, b$ as Collapse, c0 as DataGrid, c1 as GridToolbar, a5 as PeopleIcon, aI as Menu, au as ListItemIcon, aw as ListItemText, c2 as Switch, c3 as SaveIcon, c4 as Tabs, c5 as Tab, c6 as PersonIcon, c7 as WorkIcon, ag as alpha, c8 as Security, c9 as LocalHospital, ca as Home } from './vendor-Dx2XWalh.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
import { d as cn, c as apiRequest, i as isManager, a as isAdmin } from './main-Bqx8lZf7.js';
import { u as useToast } from './use-toast-3gRm_Kje.js';
import { E as EmptyState } from './cards-DnDQ5T7Q.js';
import { P as ProfilePhotoUpload } from './ProfilePhotoUpload-BRAlyxtN.js';
import { B as Button$1 } from './button-7nJ87TEV.js';
import { C as Card, a as CardContent } from './card-BoeWX9jD.js';
import { D as Dialog$1, a as DialogContent$1, b as DialogHeader, c as DialogTitle$1 } from './dialog-BtLCmaKW.js';
import { v as validateDocumentFile, u as uploadToCloudinary, U as UPLOAD_PRESETS, F as FOLDERS } from './cloudinary-DW1Kr89I.js';
  ...
  const columns = reactExports.useMemo(() => [
    ...
    },
    {
      ...
      renderCell: (params) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", flexDirection: "column", justifyContent: "center", gap: 0.5, py: 0.5 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", sx: { fontWeight: 500, lineHeight: 1.2 }, children: params.row.position }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Chip,
          {
            size: "small",
    ...
    },
    {
      ...
      renderCell: (params) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          size: "small",
          icon: params.row.isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, {}),
    ...
    },
    {
      ...
      renderCell: (params) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 0.5, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Deductions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { size: "small", onClick: () => handleOpenDeductionsDialog(params.row), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { fontSize: "small" }) }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3, minHeight: "100vh", bgcolor: "background.default" }, children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            MenuItem,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIcon, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { fontSize: "small" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: formDialogOpen, onClose: handleCloseFormDialog, maxWidth: "sm", fullWidth: true, disableRestoreFocus: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleFormSubmit, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { dividers: true, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 3, sx: { mt: 1 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", spacing: 3, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            FormControlLabel,
            {
              control: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deductionsDialogOpen, onClose: () => setDeductionsDialogOpen(false), maxWidth: "sm", fullWidth: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleDeductionsSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { sx: { pb: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { color: "primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { dividers: true, sx: { p: 0 }, children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 1.5, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Security, { sx: { fontSize: 18, color: "#3b82f6" } }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LocalHospital, { sx: { fontSize: 18, color: "#10b981" } }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Home, { sx: { fontSize: 18, color: "#8b5cf6" } }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { sx: { fontSize: 18, color: "#f59e0b" } }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2.5 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "warning", sx: { mb: 2, py: 0.5 }, icon: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", children: "These are manually managed per-period deductions (e.g. penalties)." }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { spacing: 2.5 })
        ] })
      ] }),
