import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, cX as parseISO, d2 as isFuture, aH as useMutation, Q as jsxRuntimeExports, X as Box, aj as Typography, aJ as Stack, af as IconButton, cP as RefreshIcon, aK as Button, bt as AddIcon, d3 as ToggleButtonGroup, d4 as ToggleButton, a3 as CalendarIcon, d5 as ViewListIcon, cQ as LinearProgress, bB as Alert, d6 as AlertTitle, bp as Grid, b7 as Paper, ag as alpha, al as Avatar, cr as Send, aD as SwapIcon, d7 as PendingActionsIcon, aU as CheckCircle, bl as format, c4 as Tabs, c5 as Tab, am as Chip, bu as CheckIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, b0 as FormControl, b_ as InputLabel, b1 as Select, b2 as MenuItem, bE as TextField, bH as DialogActions, bo as ArrowForward, cp as AccessTime, bz as CloseIcon, bT as CancelIcon } from './vendor-Dx2XWalh.js';
import { g as getCurrentUser, i as isManager, e as capitalizeFirstLetter, c as apiRequest, b as getInitials } from './main-Bqx8lZf7.js';
import { u as useToast } from './use-toast-3gRm_Kje.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
import { F as FullCalendar, i as index, a as index$1, b as index$2, c as index$3 } from './vendor-calendar-BJf_YqP7.js';
...
function MuiShiftTrading() {
  ...
  const getStatusChip = (status) => {
    switch (status) {
      ...
      case "approved":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: "Approved", color: "success", size: "small", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) });
      case "rejected":
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", alignItems: "flex-start", justifyContent: "space-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 2, sx: { mb: 2 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { sx: { bgcolor: "primary.main" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, {}) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3, minHeight: "100vh", bgcolor: "background.default" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid, { container: true, spacing: 3, sx: { mb: 4 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 12, sm: 6, md: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Paper,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 2, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { sx: { bgcolor: alpha(theme.palette.info.main, 0.2), color: "info.main" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 12, sm: 6, md: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Paper,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 2, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { sx: { bgcolor: alpha(theme.palette.success.main, 0.2), color: "success.main" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    ...
    viewMode === "calendar" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Paper, { sx: { p: 2, height: "700px", borderRadius: 3, overflow: "hidden", "& .fc-event": { cursor: "pointer" } }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { value: activeTab, index: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { px: 3 }, children: myRequests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { py: 8, textAlign: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 64, color: "text.disabled", mb: 2 } }),
      ...
      Dialog,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 1, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { color: "primary" }),
