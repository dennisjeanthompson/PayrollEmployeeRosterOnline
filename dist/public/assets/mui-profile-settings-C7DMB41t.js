const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-Br1LjuIs.js","assets/vendor-Bi9pq-j3.css","assets/main-CGi62jVL.js","assets/main-CUWWAj6L.css"])))=>i.map(i=>d[i]);
          ...
          Paper,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: async () => {
                  try {
                    const { logout } = await __vitePreload(async () => { const { logout } = await import('./main-CGi62jVL.js').then(n => n.l);return { logout }},true              ?__vite__mapDeps([2,0,1,3]):void 0);
                    await logout();
