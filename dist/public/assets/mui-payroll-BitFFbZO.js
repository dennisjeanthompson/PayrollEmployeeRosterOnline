const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-CXZ0NLkh.js","assets/vendor-Br1LjuIs.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-B8vDTdYq.js","assets/main-C0gODt8o.js","assets/main-CUWWAj6L.css","assets/button-CG4jjFuq.js","assets/use-toast-D9VL1-uB.js"])))=>i.map(i=>d[i]);
...
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-C0gODt8o.js';
import { u as useRealtime } from './use-realtime-CV_qTf0h.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-CXZ0NLkh.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
                  ...
                  Paper,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 1 }, children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: "Paid", color: "success", size: "small", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}), sx: { height: 24, flexShrink: 0 } })
                      ] }),
