const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-CSPGr19o.js","assets/vendor-Bi9pq-j3.css","assets/main-CD-KyDdT.js","assets/main-xPCl3CQX.css"])))=>i.map(i=>d[i]);
import { r as reactExports, aG as useQueryClient, a as React, aH as useMutation, Q as jsxRuntimeExports, X as Box, a0 as useTheme, di as Container, aj as Typography, br as Grid, b7 as Paper, ag as alpha, T as __vitePreload, am as Chip, bm as Divider, dw as BadgeIcon, dx as DateIcon, aK as Button, dy as LogoutIcon, c5 as Tabs, c6 as Tab, dz as PersonIcon, dA as SecurityIcon, bA as TextField, b_ as InputAdornment, dB as EmailIcon, c4 as SaveIcon, bE as Alert, af as IconButton, bX as VisibilityOff, bV as Visibility } from './vendor-CSPGr19o.js';
...
function MuiProfileSettings() {
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: (data) => {
      __vitePreload(async () => { const {startTransition} = await import('./vendor-CSPGr19o.js').then(n => n.R);return { startTransition }},true              ?__vite__mapDeps([0,1]):void 0).then(({ startTransition }) => {
        startTransition(() => {
          ...
          Paper,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: async () => {
                  try {
                    const { logout } = await __vitePreload(async () => { const { logout } = await import('./main-CD-KyDdT.js').then(n => n.l);return { logout }},true              ?__vite__mapDeps([2,0,1,3]):void 0);
                    await logout();
