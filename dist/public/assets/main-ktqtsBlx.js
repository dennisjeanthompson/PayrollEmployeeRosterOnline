...
const API_BASE = (() => {
  const envUrl = "https://donmacchiatos.onrender.com";
...
const MuiDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-dashboard-QrWpKgej.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0));
const MuiEmployees = reactExports.lazy(() => __vitePreload(() => import('./mui-employees-POaz6uB9.js'),true              ?__vite__mapDeps([5,1,2,6,3,7,8,9,10,11,12]):void 0));
const ScheduleV2 = reactExports.lazy(() => __vitePreload(() => import('./schedule-v2-BuzWwjPb.js'),true              ?__vite__mapDeps([13,1,2,6]):void 0));
const MuiPayroll = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-_85cgS49.js'),true              ?__vite__mapDeps([14,1,2,6,15]):void 0));
const MuiNotifications = reactExports.lazy(() => __vitePreload(() => import('./mui-notifications-0i3tyaVU.js'),true              ?__vite__mapDeps([16,1,2,3,6]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-shift-trading-Bbh8HR_m.js'),true              ?__vite__mapDeps([17,1,2,3,6,18]):void 0));
const MuiBranches = reactExports.lazy(() => __vitePreload(() => import('./mui-branches-Cit__24n.js'),true              ?__vite__mapDeps([4,1,2,3]):void 0));
const MuiReports = reactExports.lazy(() => __vitePreload(() => import('./mui-reports-CCBSizXw.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0));
const MuiAnalytics = reactExports.lazy(() => __vitePreload(() => import('./mui-analytics-Cz43KGZW.js'),true              ?__vite__mapDeps([20,1,2,6,21]):void 0));
const MuiLogin = reactExports.lazy(() => __vitePreload(() => import('./mui-login-BeiKs7zm.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-time-off-CPkitOJa.js'),true              ?__vite__mapDeps([23,1,2,3,6]):void 0));
const MuiDeductionSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-deduction-settings-DQYNgssZ.js'),true              ?__vite__mapDeps([24,1,2,6,3]):void 0));
const MuiPayrollManagement = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-management-BQ2OM0MQ.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,15,12,9]):void 0));
const MuiAdminDeductionRates = reactExports.lazy(() => __vitePreload(() => import('./mui-admin-deduction-rates-CEuebwyV.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0));
const MuiAuditLogs = reactExports.lazy(() => __vitePreload(() => import('./mui-audit-logs-CBel0pYT.js'),true              ?__vite__mapDeps([28,1,2,6]):void 0));
const MuiHolidayCalendar = reactExports.lazy(() => __vitePreload(() => import('./mui-holiday-calendar-86VHP9aH.js'),true              ?__vite__mapDeps([29,1,2,6,3]):void 0));
const MuiComplianceDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-compliance-dashboard-U2KXTN1n.js'),true              ?__vite__mapDeps([30,1,2]):void 0));
const MuiProfileSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-profile-settings-GrHvKl2c.js'),true              ?__vite__mapDeps([31,1,2,6,8,9,10,3]):void 0));
const MuiCompanySettings = reactExports.lazy(() => __vitePreload(() => import('./mui-company-settings-Bl57wR9E.js'),true              ?__vite__mapDeps([32,1,2,6,3,10]):void 0));
const Mui13thMonth = reactExports.lazy(() => __vitePreload(() => import('./mui-13th-month-v29wd7y8.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0));
const MuiLeaveCredits = reactExports.lazy(() => __vitePreload(() => import('./mui-leave-credits-DHbbCXpg.js'),true              ?__vite__mapDeps([34,1,2,6,3,7]):void 0));
const MuiRequests = reactExports.lazy(() => __vitePreload(() => import('./mui-requests-DBTKUMqG.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0));
const MobileRequests = reactExports.lazy(() => __vitePreload(() => import('./mobile-requests-ksZd_Gs5.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0));
const MobileMore = reactExports.lazy(() => __vitePreload(() => import('./mobile-more-NUnGD9Gx.js'),true              ?__vite__mapDeps([37,1,2]):void 0));
const Setup = reactExports.lazy(() => __vitePreload(() => import('./setup-BwFPM4Ps.js'),true              ?__vite__mapDeps([38,1,2,11,9,3]):void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import('./not-found-CFmZhqmf.js'),true              ?__vite__mapDeps([39,1,2,9]):void 0));
const prefetchRoutes = () => {
  const idleCallback = typeof requestIdleCallback !== "undefined" ? requestIdleCallback : setTimeout;
  idleCallback(() => {
    __vitePreload(() => import('./mui-dashboard-QrWpKgej.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0);
    __vitePreload(() => import('./schedule-v2-BuzWwjPb.js'),true              ?__vite__mapDeps([13,1,2,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-employees-POaz6uB9.js'),true              ?__vite__mapDeps([5,1,2,6,3,7,8,9,10,11,12]):void 0);
    __vitePreload(() => import('./mui-payroll-management-BQ2OM0MQ.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,15,12,9]):void 0);
    __vitePreload(() => import('./mui-notifications-0i3tyaVU.js'),true              ?__vite__mapDeps([16,1,2,3,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-reports-CCBSizXw.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0);
    __vitePreload(() => import('./mui-requests-DBTKUMqG.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0);
    __vitePreload(() => import('./mui-profile-settings-GrHvKl2c.js'),true              ?__vite__mapDeps([31,1,2,6,8,9,10,3]):void 0);
    __vitePreload(() => import('./mobile-requests-ksZd_Gs5.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0);
  });
};
