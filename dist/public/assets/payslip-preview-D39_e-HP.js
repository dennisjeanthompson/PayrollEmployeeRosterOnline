import{r as k,j as t,a8 as pe,a9 as he}from"./react-vendor-B-4zd3r2.js";import{u as me}from"./vendor-query-BISSAvkB.js";import{bn as z,bo as xe,bp as ue,bq as W,br as be,aJ as y,bs as ye}from"./vendor-DLhOFOkX.js";import{g as ge}from"./payroll-dates-DN073uIB.js";import{D as A,a as I,c as L,d as O}from"./dialog-CAu-60L_.js";import{B as R}from"./button-DJyx3RsZ.js";import{d as $,c as fe}from"./main-BPjzDF6P.js";import{u as we}from"./use-toast-CxZLuevk.js";import"./mui-core-C1LuIDVx.js";import"./vendor-calendar-BPsvKESR.js";import"./mui-icons-DXOd-f9U.js";const _=k.forwardRef(({className:p,children:h,...f},j)=>t.jsxs(z,{ref:j,className:$("relative overflow-hidden",p),...f,children:[t.jsx(xe,{className:"h-full w-full rounded-[inherit]",children:h}),t.jsx(G,{}),t.jsx(ue,{})]}));_.displayName=z.displayName;const G=k.forwardRef(({className:p,orientation:h="vertical",...f},j)=>t.jsx(W,{ref:j,orientation:h,className:$("flex touch-none select-none transition-colors",h==="vertical"&&"h-full w-2.5 border-l border-l-transparent p-[1px]",h==="horizontal"&&"h-2.5 flex-col border-t border-t-transparent p-[1px]",p),...f,children:t.jsx(be,{className:"relative flex-1 rounded-full bg-border"})}));G.displayName=W.displayName;const Ne=`
