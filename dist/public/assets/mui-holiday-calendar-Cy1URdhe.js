const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HolidayCalendarView-CCF68OpF.js","assets/vendor-CSPGr19o.js","assets/vendor-Bi9pq-j3.css","assets/vendor-calendar-BtSH9WeT.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, aG as useQueryClient, r as reactExports, bl as format, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, an as Tooltip, X as Box, ag as alpha, aj as Typography, aM as CircularProgress, a3 as CalendarIcon, aJ as Stack, bA as TextField, b2 as MenuItem, aK as Button, cO as RefreshIcon, bp as AddIcon, cP as LinearProgress, bt as Card, bu as CardContent, c5 as Tabs, c6 as Tab, cQ as TableContainer, cR as Table, cS as TableHead, cT as TableRow, cU as TableCell, cV as TableBody, am as Chip, aU as CheckCircle, co as Block, af as IconButton, bW as EditIcon, bG as DeleteIcon, bx as CloseIcon, ay as Dialog, by as DialogTitle, bz as DialogContent, cB as LocalizationProvider, cC as AdapterDateFns, cE as DatePicker, bH as FormControlLabel, c3 as Switch, bB as DialogActions, bE as Alert, T as __vitePreload } from './vendor-CSPGr19o.js';
import { u as useRealtime } from './use-realtime-SSpX4tF2.js';
import { u as useAuth, c as apiRequest } from './main-CD-KyDdT.js';
import { u as useToast } from './use-toast-fxvX43TA.js';

const HolidayCalendarView = reactExports.lazy(() => __vitePreload(() => import('./HolidayCalendarView-CCF68OpF.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0));
const holidayTypes = [
