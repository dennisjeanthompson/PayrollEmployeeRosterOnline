import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, aM as CircularProgress, ag as alpha, ad as HistoryIcon, aJ as Stack, aj as Typography, an as Tooltip, av as Badge, d0 as DotIcon, br as Card, bs as CardContent, dg as CardHeader, du as FilterIcon, bE as TextField, b2 as MenuItem, aK as Button, ae as DownloadIcon, cR as TableContainer, b7 as Paper, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, bl as format, am as Chip, c6 as PersonIcon, aO as formatDistanceToNow, af as IconButton, bU as Visibility, dv as TablePagination, aq as Drawer, bz as CloseIcon, bm as Divider, b4 as Snackbar, bB as Alert, bt as AddIcon, bD as DeleteIcon, aU as CheckCircle, bT as CancelIcon, dw as PaymentIcon, aD as SwapIcon, aC as ScheduleIcon, ac as SettingsIcon, bV as EditIcon } from './vendor-Dx2XWalh.js';
import { c as apiRequest } from './main-Bqx8lZf7.js';
...
const getActionIcon = (action) => {
  ...
  if (action.includes("approve") || action.includes("activate") || action.includes("paid")) return /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { fontSize: "small" });
  ...
  if (action.includes("trade") || action.includes("swap")) return /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { fontSize: "small" });
