import { r as reactExports, a0 as useTheme, Q as jsxRuntimeExports, X as Box, a6 as AssignmentIcon, aj as Typography, c5 as Tabs, c6 as Tab, a3 as CalendarIcon } from './vendor-v-EuVKxF.js';
import MuiTimeOff from './mui-time-off-X372fXr0.js';
import './main-fla130dr.js';
import './use-toast-BDUJuTfF.js';
import './use-realtime-DiQyjgYE.js';
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { borderBottom: 1, borderColor: "divider", bgcolor: "background.paper", px: { xs: 2, sm: 4 }, pt: 3 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", mb: 2 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "Review and approve Time Off and Government Loans" })
        ] })
      ] }),
