import { a0 as useTheme, aG as useQueryClient, $ as useLocation, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, ag as alpha, bq as TaxIcon, aj as Typography, aJ as Stack, bA as TextField, b_ as InputAdornment, az as Search, aK as Button, bp as AddIcon, br as Grid, a3 as CalendarIcon, dn as Speed, bs as AccessTime, bt as Card, bu as CardContent, am as Chip, aU as CheckCircle, bU as CancelIcon, bm as Divider, ac as SettingsIcon, c5 as Tabs, c6 as Tab, dp as Groups, ce as NoteAdd, aM as CircularProgress, bl as format, dq as differenceInDays, an as Tooltip, bD as WarningIcon, dr as PlayArrow, bV as Visibility, af as IconButton, cM as MoreVert, cP as LinearProgress, b0 as FormControl, b1 as Select, b2 as MenuItem, ae as DownloadIcon, cQ as TableContainer, cR as Table, cS as TableHead, cT as TableRow, cU as TableCell, cV as TableBody, al as Avatar, cX as DescriptionIcon, cr as Send, aC as ScheduleIcon, c3 as Switch, ay as Dialog, by as DialogTitle, bz as DialogContent, cB as LocalizationProvider, cC as AdapterDateFns, cE as DatePicker, bE as Alert, b7 as Paper, bB as DialogActions, b$ as InputLabel, cK as eachDayOfInterval, aI as Menu, au as ListItemIcon, aw as ListItemText, ds as ExportIcon, bG as DeleteIcon, cf as addDays, bS as startOfMonth, bT as endOfMonth, ch as subDays } from './vendor-CSPGr19o.js';
import { P as PesoIcon, b as getInitials, j as apiUrl, c as apiRequest } from './main-BPmoyhc1.js';
import { u as useToast } from './use-toast-fxvX43TA.js';
import { u as useRealtime } from './use-realtime-OpF-eZ2D.js';
import { PayslipPreview } from './payslip-preview-BDc4D8A4.js';
import './payroll-dates-BmATSNY8.js';
import './dialog-Bk2Am-L5.js';
import './button-CsUxrk98.js';
...
function MuiPayrollManagement() {
  ...
  const [runType, setRunType] = reactExports.useState("regular");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { sx: { pt: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 3, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Box,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", color: "warning.main", fontWeight: 600, sx: { mb: 2 }, children: "⚙️ Run Type" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      fullWidth: true,
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "regular", children: "Regular (Full Deductions)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "bonus", children: "Bonus (No Statutory)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "13th_month", children: "13th Month (No Statutory)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "final_pay", children: "Final Pay (Custom)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "correction", children: "Correction" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "off_cycle", children: "Off-Cycle" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", sx: { mt: 1, display: "block" }, children: "Run types automatically handle deduction profiles (e.g. skipping SSS for bonuses)." })
                ]
              }
            ),
