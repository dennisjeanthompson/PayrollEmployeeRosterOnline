...
import { g as getCurrentUser, i as isManager, a as isAdmin, P as PesoIcon, T as TransitionLink, b as getInitials, c as apiRequest } from './main-BO1M6mNA.js';
import { u as useToast } from './use-toast-D9VL1-uB.js';
import MuiBranches from './mui-branches-DtlScVjH.js';
                ...
                Paper,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { px: 2, py: 1.5, borderBottom: `1px solid ${theme.palette.divider}` }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", justifyContent: "space-between", alignItems: "center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", sx: { fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.8 }, children: latestPaidEntry && !activeEntry ? "Latest Payslip" : "Current Pay Period" }),
