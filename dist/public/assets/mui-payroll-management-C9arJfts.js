import { a0 as useTheme, aG as useQueryClient, $ as useLocation, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, ag as alpha, bv as Receipt, aj as Typography, aJ as Stack, b0 as FormControl, b_ as InputLabel, b1 as Select, b2 as MenuItem, bE as TextField, bZ as InputAdornment, az as Search, aK as Button, bt as AddIcon, bp as Grid, a3 as CalendarIcon, dp as Speed, cp as AccessTime, br as Card, bs as CardContent, am as Chip, aU as CheckCircle, bT as CancelIcon, bm as Divider, ac as SettingsIcon, c4 as Tabs, c5 as Tab, dq as Groups, ce as NoteAdd, aM as CircularProgress, bl as format, dr as differenceInDays, an as Tooltip, by as WarningIcon, ds as PlayArrow, bU as Visibility, af as IconButton, cN as MoreVert, cQ as LinearProgress, ae as DownloadIcon, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, al as Avatar, cY as DescriptionIcon, cr as Send, aC as ScheduleIcon, c2 as Switch, bD as DeleteIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, cC as LocalizationProvider, cD as AdapterDateFns, cF as DatePicker, bF as FormControlLabel, bB as Alert, b7 as Paper, bH as DialogActions, cK as eachDayOfInterval, aI as Menu, au as ListItemIcon, aw as ListItemText, dt as ExportIcon, bR as startOfMonth, bS as endOfMonth, cg as subDays } from './vendor-Dx2XWalh.js';
import { a as isAdmin, P as PesoIcon, b as getInitials, j as apiUrl, c as apiRequest } from './main-Bqx8lZf7.js';
import { u as useToast } from './use-toast-3gRm_Kje.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
import { PayslipPreview } from './payslip-preview-kM9VPQZA.js';
import './payroll-dates-BmATSNY8.js';
import './dialog-BtLCmaKW.js';
import './button-7nJ87TEV.js';
...
function MuiPayrollManagement() {
  ...
  const [selectedBranchId, setSelectedBranchId] = reactExports.useState(adminUser ? "all" : "");
  ...
  const [periodConfig, setPeriodConfig] = reactExports.useState({
    deductSSS: true,
  ...
  const handleCreatePeriod = () => {
    ...
    if (overlapping.length > 0 && !confirm(`⚠️ A period already exists for these dates (${overlapping.map((p) => `${format(new Date(p.startDate), "MMM d")}–${format(new Date(p.endDate), "MMM d")}`).join(", ")}). Create anyway?`)) {
      return;
    }
      ...
      Box,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 2 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Box,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { sx: { color: "white" } })
              }
            ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, alignItems: "center", children: [
            adminUser && /* @__PURE__ */ jsxRuntimeExports.jsxs(FormControl, { size: "small", sx: { minWidth: 180 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    ...
                    allBranches.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: b.id, children: b.name }, b.id))
                  ]
                }
              )
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1.5, flexWrap: "wrap" }, children: [
            ...
            [
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                Chip,
                {
                  icon: isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, { sx: { fontSize: 16 } }),
                  label: item.label,
                  size: "small",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Chip,
              {
                icon: companySettings?.includeHolidayPay ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, { sx: { fontSize: 16 } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, { orientation: "vertical", flexItem: true, sx: { mx: 0.5 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 700, color: "text.secondary", sx: { mr: 0.5 }, children: "Night Diff:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Chip,
              {
                icon: deductionProfile?.includeNightDiff ?? true ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, { sx: { fontSize: 16 } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, { orientation: "vertical", flexItem: true, sx: { mx: 0.5 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 700, color: "text.secondary", sx: { mr: 0.5 }, children: "Exceptions:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Chip,
              {
                icon: deductionProfile?.includeExceptionLogs ?? true ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16 } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, { sx: { fontSize: 16 } }),
              ...
              Box,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1.5, alignItems: "center", children: [
                    ...
                    parseFloat(String(period.totalHours || 0)) === 0 && parseFloat(String(period.totalPay || 0)) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Warning: Zero hours logged but non-zero payout", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WarningIcon, { color: "warning", sx: { fontSize: 18 } }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: !selectedPeriod ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 6, textAlign: "center" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { sx: { fontSize: 48, color: "text.disabled", mb: 2 } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { sx: { fontSize: 48, color: "warning.main", mb: 2 } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: entries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { hover: true, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { align: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 0.5, justifyContent: "flex-end", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "View digital payslip (PH — Compliant)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IconButton,
                    {
                      size: "small",
                      color: "info",
                  ...
                  entry.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Approve", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IconButton,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { fontSize: "small" })
                    }
                  ) }),
            ...
            adjLogsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { p: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LinearProgress, {}) }) : adjLogs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 6, textAlign: "center" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: adjLogs.map((log) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { hover: true, sx: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { align: "center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: logIncluded ? "Included — will affect next payroll run" : "Excluded — will be skipped during payroll", arrow: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Switch,
                    {
                      size: "small",
                      checked: logIncluded,
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.disabled", children: "—" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { align: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", spacing: 0.5, justifyContent: "flex-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Delete entry", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IconButton,
                    {
                      size: "small",
                      color: "error",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { sx: { pt: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 3, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Box,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", color: "info.main", fontWeight: 600, sx: { mb: 2 }, children: "⚙️ Payroll Configuration" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid, { container: true, spacing: 2, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.deductSSS, onChange: (e) => setPeriodConfig({ ...periodConfig, deductSSS: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "SSS" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.deductPhilHealth, onChange: (e) => setPeriodConfig({ ...periodConfig, deductPhilHealth: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "PhilHealth" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.deductPagibig, onChange: (e) => setPeriodConfig({ ...periodConfig, deductPagibig: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "Pag-IBIG" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.deductWithholdingTax, onChange: (e) => setPeriodConfig({ ...periodConfig, deductWithholdingTax: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "Tax" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.includeHolidayPay, onChange: (e) => setPeriodConfig({ ...periodConfig, includeHolidayPay: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "Holiday Pay" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 6, sm: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.includeNightDiff, onChange: (e) => setPeriodConfig({ ...periodConfig, includeNightDiff: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "Night Diff" })
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormControlLabel,
                      {
                        control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { size: "small", checked: periodConfig.includeExceptionLogs, onChange: (e) => setPeriodConfig({ ...periodConfig, includeExceptionLogs: e.target.checked }) }),
                        label: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", children: "Include Exception Logs (OT, Late, Absent)" })
                      }
                    ) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", sx: { mt: 1.5, display: "block" }, children: "Defaults loaded from Deduction Settings. Changes here apply to this period only." })
                ]
              }
            ),
            startDate && endDate && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              periods.some((p) => p.status === "open" && new Date(p.startDate) <= endDate && new Date(p.endDate) >= startDate) && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "warning", sx: { borderRadius: 2 }, children: "Warning: This date range overlaps with an existing open payroll period." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Paper,
                {
                  elevation: 0,
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 1, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { color: "success.main", fontSize: 20 } }),
