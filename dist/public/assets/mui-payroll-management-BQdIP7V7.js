import { a0 as useTheme, aG as useQueryClient, $ as useLocation, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, ag as alpha, bq as TaxIcon, aj as Typography, aJ as Stack, bA as TextField, b_ as InputAdornment, az as Search, aK as Button, bp as AddIcon, br as Grid, a3 as CalendarIcon, dm as Speed, bs as AccessTime, bt as Card, bu as CardContent, am as Chip, aU as CheckCircle, bU as CancelIcon, bm as Divider, ac as SettingsIcon, c5 as Tabs, c6 as Tab, dn as Groups, ce as NoteAdd, aM as CircularProgress, bl as format, dp as differenceInDays, an as Tooltip, bD as WarningIcon, dq as PlayArrow, bV as Visibility, af as IconButton, cL as MoreVert, cO as LinearProgress, b0 as FormControl, b1 as Select, b2 as MenuItem, ae as DownloadIcon, cP as TableContainer, cQ as Table, cR as TableHead, cS as TableRow, cT as TableCell, cU as TableBody, al as Avatar, cW as DescriptionIcon, cr as Send, aC as ScheduleIcon, c3 as Switch, ay as Dialog, by as DialogTitle, bz as DialogContent, cB as LocalizationProvider, cC as AdapterDateFns, cF as DatePicker, bE as Alert, b7 as Paper, bB as DialogActions, b$ as InputLabel, cJ as eachDayOfInterval, aI as Menu, au as ListItemIcon, aw as ListItemText, dr as ExportIcon, bG as DeleteIcon, cf as addDays, bS as startOfMonth, bT as endOfMonth, ch as subDays } from './vendor-D1hggvo0.js';
import { P as PesoIcon, b as getInitials, j as apiUrl, c as apiRequest } from './main-BCIEvjoh.js';
import { u as useToast } from './use-toast-C3_XMGdR.js';
import { u as useRealtime } from './use-realtime-hJqL-UrP.js';
import { PayslipPreview } from './payslip-preview-D0FXWxYH.js';
import './payroll-dates-BmATSNY8.js';
import './dialog-ms6BAP6V.js';
import './button-BkR4JcB4.js';
      ...
      Dialog,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { sx: { pt: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 3, children: [
            ...
            startDate && endDate && payDate && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
