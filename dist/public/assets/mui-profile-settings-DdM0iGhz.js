const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-Dx2XWalh.js","assets/vendor-Bi9pq-j3.css","assets/main-Bqx8lZf7.js","assets/main-CUWWAj6L.css"])))=>i.map(i=>d[i]);
import { r as reactExports, aG as useQueryClient, a as React, aH as useMutation, Q as jsxRuntimeExports, X as Box, a0 as useTheme, dj as Container, aj as Typography, bp as Grid, b7 as Paper, ag as alpha, T as __vitePreload, am as Chip, bm as Divider, dx as BadgeIcon, dy as DateIcon, aK as Button, dz as LogoutIcon, c4 as Tabs, c5 as Tab, dA as PersonIcon, dB as SecurityIcon, bE as TextField, bZ as InputAdornment, dC as EmailIcon, c3 as SaveIcon, bB as Alert, af as IconButton, bW as VisibilityOff, bU as Visibility } from './vendor-Dx2XWalh.js';
...
function MuiProfileSettings() {
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: (data) => {
      __vitePreload(async () => { const {startTransition} = await import('./vendor-Dx2XWalh.js').then(n => n.R);return { startTransition }},true              ?__vite__mapDeps([0,1]):void 0).then(({ startTransition }) => {
        startTransition(() => {
          ...
          Paper,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: async () => {
                  try {
                    const { logout } = await __vitePreload(async () => { const { logout } = await import('./main-Bqx8lZf7.js').then(n => n.l);return { logout }},true              ?__vite__mapDeps([2,0,1,3]):void 0);
                    await logout();
