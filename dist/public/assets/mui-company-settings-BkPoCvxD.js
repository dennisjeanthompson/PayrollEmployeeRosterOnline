import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, aM as CircularProgress, bB as Alert, aJ as Stack, al as Avatar, ag as alpha, a9 as BusinessIcon, aj as Typography, aK as Button, bV as EditIcon, br as Card, bs as CardContent, am as Chip, bp as Grid, bE as TextField, b2 as MenuItem, dK as ImageIcon, b3 as LocationIcon, dc as PhoneIcon, dd as EmailIcon, dL as WebIcon, dM as BadgeIcon, dN as AccountBalance, c3 as SaveIcon, aU as CheckCircle } from './vendor-Dx2XWalh.js';
...
import { a as validateImageFile, F as FOLDERS, u as uploadToCloudinary, U as UPLOAD_PRESETS } from './cloudinary-DW1Kr89I.js';
...
function MuiCompanySettings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: { xs: 2, md: 3 }, maxWidth: 1200, mx: "auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { sx: { mb: 3 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 1, sx: { mb: 2 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccountBalance, { color: "primary" }),
    ...
    data?.updatedAt && !isEditing && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { textAlign: "right", mt: 2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", justifyContent: "flex-end", spacing: 0.5, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16, color: "success.main" } }),
