const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/payslip-preview-CUisTJgP.js","assets/vendor-CQpdGtSm.js","assets/vendor-Bi9pq-j3.css","assets/payroll-dates-BmATSNY8.js","assets/dialog-BbRQErtY.js","assets/main-CXSQmcn6.js","assets/main-CUWWAj6L.css","assets/button-D6ZR5rlp.js","assets/use-toast-CyhX0tAV.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, r as reactExports, ax as useQuery, Q as jsxRuntimeExports, X as Box, bk as motion, ag as alpha, aJ as Stack, aj as Typography, an as Tooltip, af as IconButton, cP as RefreshIcon, cQ as LinearProgress, bp as Grid, bv as Receipt, cp as AccessTime, b7 as Paper, al as Avatar, bn as Skeleton, am as Chip, c4 as Tabs, c5 as Tab, ad as HistoryIcon, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, a3 as CalendarIcon, bl as format, cX as parseISO, aS as AdjustmentIcon, aU as CheckCircle, cY as DescriptionIcon, ae as DownloadIcon, bm as Divider, aK as Button, T as __vitePreload } from './vendor-CQpdGtSm.js';
import { P as PesoIcon, g as getCurrentUser, c as apiRequest } from './main-CXSQmcn6.js';
import { u as useRealtime } from './use-realtime-B9HyWmzN.js';
import { g as getPaymentDate } from './payroll-dates-BmATSNY8.js';

const DigitalPayslip = reactExports.lazy(() => __vitePreload(() => import('./payslip-preview-CUisTJgP.js'),true              ?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):void 0));
...
function MuiPayroll() {
  ...
  const lastPayAmount = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 3, minHeight: "100vh", bgcolor: "background.default" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { container: true, spacing: 2, sx: { mb: 3 }, children: [
      ...
      { label: "Latest Net Pay", value: formatCurrency(lastPayAmount), icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { fontSize: "small" }), color: theme.palette.info.main },
      { label: "YTD Hours Worked", value: `${totalHoursYTD.toFixed(1)}h`, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(AccessTime, { fontSize: "small" }), color: theme.palette.primary.main }
    ].map((stat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { size: { xs: 12, md: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { mb: 4 }, children: payrollLoading && !currentEntry ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Paper,
      {
        elevation: 0,
        sx: {
          ...
          Paper,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Tabs,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Tab, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, {}), iconPosition: "start", label: "Payslips" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { value: activeTab, index: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { px: 3 }, children: paidEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { py: 8, textAlign: "center" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.disabled", children: "Your generated payroll entries will appear here" })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
                  ...
                  Paper,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 1 }, children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: "Generated", color: "success", size: "small", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}), sx: { height: 24, flexShrink: 0 } })
                      ] }),
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Paper,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", justifyContent: "space-between", sx: { mb: 2, position: "relative", zIndex: 1 }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { sx: { bgcolor: alpha(theme.palette.primary.main, 0.1), color: "primary.main", width: 44, height: 44 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, {}) }),
