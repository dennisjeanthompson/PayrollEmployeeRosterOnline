import { l, D, y, x, _, i, G, j, d, r as reactExports, a as React, b as reactDomExports } from './vendor-5dgU3tca.js';
...
class FullCalendar extends reactExports.Component {
    constructor() {
        super(...arguments);
        this.elRef = reactExports.createRef();
    ...
    componentDidMount() {
        ...
        customRenderingStore.subscribe((customRenderingMap) => {
            ...
            syncRenderingByDefault ||
                ...
                : reactDomExports.flushSync; // guaranteed sync rendering
            runFunc(() => {
...
class CustomRenderingComponent extends reactExports.PureComponent {
    render() {
        ...
        const vnode = typeof generatorMeta === 'function' ?
            ...
            generatorMeta;
        return reactDomExports.createPortal(vnode, customRendering.containerEl);
    }
}
// Util
// -------------------------------------------------------------------------------------------------
...
export { FullCalendar as F, index$2 as a, index$1 as b, index as c, index$3 as i };
