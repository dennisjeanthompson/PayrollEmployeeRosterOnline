import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, aj as Typography, aJ as Stack, af as IconButton, cP as RefreshIcon, aK as Button, bt as AddIcon, b7 as Paper, ag as alpha, al as Avatar, aD as SwapIcon, a2 as DashboardIcon, an as Tooltip, am as Chip, d8 as LockIcon, bB as Alert, d6 as AlertTitle, cQ as LinearProgress, bp as Grid, a8 as StoreIcon, aU as CheckCircle, a5 as PeopleIcon, a9 as BusinessIcon, d9 as AccountTreeIcon, bm as Divider, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, bU as Visibility, av as Badge, bT as CancelIcon, da as ToggleOn, db as ToggleOff, bV as EditIcon, b3 as LocationIcon, dc as PhoneIcon, dd as EmailIcon, de as ExpandLessIcon, ck as ExpandMore, b$ as Collapse, ar as List, as as ListItem, df as ListItemAvatar, aw as ListItemText, ay as Dialog, bx as DialogTitle, bA as DialogContent, bE as TextField, bF as FormControlLabel, c2 as Switch, bH as DialogActions, by as WarningIcon, bl as format, cX as parseISO } from './vendor-Dx2XWalh.js';
import { u as useAuth, a as isAdmin, i as isManager, f as isEmployee, h as invalidateQueries, c as apiRequest } from './main-Bqx8lZf7.js';
      ...
      Paper,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: { xs: "column", sm: "row" }, alignItems: { xs: "stretch", sm: "center" }, spacing: 2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", alignItems: "center", spacing: 1.5, sx: { flex: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { sx: { bgcolor: alpha(theme.palette.primary.main, 0.15), color: "primary.main" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Chip,
                      {
                        ...
                        size: "small",
                        color: branch.isActive ? "success" : "default",
                        icon: branch.isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(CancelIcon, {})
                      }
                    )
                  ] })
                ] }),
                canManage && /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: branch.isActive ? "Deactivate" : "Activate", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    IconButton,
                    {
                      ...
                      children: branch.isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleOn, { color: "success" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleOff, { color: "disabled" })
                    }
                  ) }),
