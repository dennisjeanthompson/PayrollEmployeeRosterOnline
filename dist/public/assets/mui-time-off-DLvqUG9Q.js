import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, aJ as Stack, aj as Typography, aE as EventIcon, aK as Button, bt as AddIcon, bp as Grid, br as Card, bs as CardContent, b0 as FormControl, b_ as InputLabel, b1 as Select, b2 as MenuItem, dg as CardHeader, bm as Divider, aM as CircularProgress, bB as Alert, aR as InfoIcon, c0 as DataGrid, ag as alpha, am as Chip, bl as format, cX as parseISO, ay as Dialog, bx as DialogTitle, bA as DialogContent, b7 as Paper, cC as LocalizationProvider, cD as AdapterDateFns, cF as DatePicker, dr as differenceInDays, by as WarningIcon, bE as TextField, bH as DialogActions, bP as y, bT as CancelIcon, cp as AccessTime, aU as CheckCircle } from './vendor-Dx2XWalh.js';
import { g as getCurrentUser, i as isManager, e as capitalizeFirstLetter, c as apiRequest } from './main-Bqx8lZf7.js';
...
const getStatusIcon = (status) => {
  switch (status) {
    case "approved":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 18 } });
    case "rejected":
