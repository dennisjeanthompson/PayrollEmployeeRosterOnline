...
const MuiDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-dashboard-BCwYnyu1.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0));
const MuiEmployees = reactExports.lazy(() => __vitePreload(() => import('./mui-employees-dXcK8uxo.js'),true              ?__vite__mapDeps([5,1,2,6,3,4,7,8,9,10,11]):void 0));
const ScheduleV2 = reactExports.lazy(() => __vitePreload(() => import('./schedule-v2-DqD4yVC2.js'),true              ?__vite__mapDeps([12,1,2,6]):void 0));
const MuiPayroll = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-D4lxrqHP.js'),true              ?__vite__mapDeps([13,1,2,6,14]):void 0));
const MuiNotifications = reactExports.lazy(() => __vitePreload(() => import('./mui-notifications-DfLdo0fW.js'),true              ?__vite__mapDeps([15,1,2,3,6]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-shift-trading-DlCQrcGY.js'),true              ?__vite__mapDeps([16,1,2,3,6,17]):void 0));
const MuiBranches = reactExports.lazy(() => __vitePreload(() => import('./mui-branches-Bs_rqfGz.js'),true              ?__vite__mapDeps([18,1,2,3]):void 0));
const MuiReports = reactExports.lazy(() => __vitePreload(() => import('./mui-reports-3e2FeFep.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0));
const MuiAnalytics = reactExports.lazy(() => __vitePreload(() => import('./mui-analytics-BlXcyKzl.js'),true              ?__vite__mapDeps([20,1,2,6,21]):void 0));
const MuiLogin = reactExports.lazy(() => __vitePreload(() => import('./mui-login-Cmg840YT.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-time-off-DLvqUG9Q.js'),true              ?__vite__mapDeps([23,1,2,3,6]):void 0));
const MuiDeductionSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-deduction-settings-DvZNPTGC.js'),true              ?__vite__mapDeps([24,1,2,6,3]):void 0));
const MuiPayrollManagement = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-management-C9arJfts.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,14,11,8]):void 0));
const MuiAdminDeductionRates = reactExports.lazy(() => __vitePreload(() => import('./mui-admin-deduction-rates-BzLzcGgE.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0));
const MuiAuditLogs = reactExports.lazy(() => __vitePreload(() => import('./mui-audit-logs-8Qjklmf8.js'),true              ?__vite__mapDeps([28,1,2,6]):void 0));
const MuiHolidayCalendar = reactExports.lazy(() => __vitePreload(() => import('./mui-holiday-calendar-CvtWxWJB.js'),true              ?__vite__mapDeps([29,1,2,6,3]):void 0));
const MuiComplianceDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-compliance-dashboard-BWaJ_FOD.js'),true              ?__vite__mapDeps([30,1,2]):void 0));
const MuiProfileSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-profile-settings-DdM0iGhz.js'),true              ?__vite__mapDeps([31,1,2,6,7,8,9,3]):void 0));
const MuiCompanySettings = reactExports.lazy(() => __vitePreload(() => import('./mui-company-settings-BkPoCvxD.js'),true              ?__vite__mapDeps([32,1,2,6,3,9]):void 0));
const Mui13thMonth = reactExports.lazy(() => __vitePreload(() => import('./mui-13th-month-C9B8dDbe.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0));
const MuiLeaveCredits = reactExports.lazy(() => __vitePreload(() => import('./mui-leave-credits-B-jYWWXn.js'),true              ?__vite__mapDeps([34,1,2,6,3,4]):void 0));
const MuiRequests = reactExports.lazy(() => __vitePreload(() => import('./mui-requests-rOL2EIT_.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0));
const MobileRequests = reactExports.lazy(() => __vitePreload(() => import('./mobile-requests-Df1CrPP9.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0));
const MobileMore = reactExports.lazy(() => __vitePreload(() => import('./mobile-more-B6sx7Iog.js'),true              ?__vite__mapDeps([37,1,2]):void 0));
const Setup = reactExports.lazy(() => __vitePreload(() => import('./setup-DTe3NipD.js'),true              ?__vite__mapDeps([38,1,2,10,8,3]):void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import('./not-found-DJoP1UhM.js'),true              ?__vite__mapDeps([39,1,2,8]):void 0));
const prefetchRoutes = () => {
  const idleCallback = typeof requestIdleCallback !== "undefined" ? requestIdleCallback : setTimeout;
  idleCallback(() => {
    __vitePreload(() => import('./mui-dashboard-BCwYnyu1.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0);
    __vitePreload(() => import('./schedule-v2-DqD4yVC2.js'),true              ?__vite__mapDeps([12,1,2,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-employees-dXcK8uxo.js'),true              ?__vite__mapDeps([5,1,2,6,3,4,7,8,9,10,11]):void 0);
    __vitePreload(() => import('./mui-payroll-management-C9arJfts.js'),true              ?__vite__mapDeps([25,1,2,3,6,26,14,11,8]):void 0);
    __vitePreload(() => import('./mui-notifications-DfLdo0fW.js'),true              ?__vite__mapDeps([15,1,2,3,6]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-reports-3e2FeFep.js'),true              ?__vite__mapDeps([19,1,2,6]):void 0);
    __vitePreload(() => import('./mui-requests-rOL2EIT_.js'),true              ?__vite__mapDeps([35,1,2,23,3,6]):void 0);
    __vitePreload(() => import('./mui-profile-settings-DdM0iGhz.js'),true              ?__vite__mapDeps([31,1,2,6,7,8,9,3]):void 0);
    __vitePreload(() => import('./mobile-requests-Df1CrPP9.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0);
  });
};
