import { a as React, a0 as useTheme, a1 as useMediaQuery, bl as format, cb as isToday, cc as addDays, Q as jsxRuntimeExports, X as Box, ag as alpha, aj as Typography, am as Chip, cd as differenceInHours, aD as SwapIcon, al as Avatar, an as Tooltip, af as IconButton, ce as NoteAdd, bu as CheckIcon, bw as isValid, bT as CancelIcon, aU as CheckCircle, cf as PendingIcon, bk as motion, bt as AddIcon, ai as ChevronLeftIcon, cg as subDays, ah as ChevronRightIcon, ch as VacationIcon, bV as EditIcon, r as reactExports, ci as Accordion, cj as AccordionSummary, ck as ExpandMore, cl as AccordionDetails, cm as EventBusyIcon, aJ as Stack, br as Card, bs as CardContent, aK as Button, cn as Block, bm as Divider, aC as ScheduleIcon, bz as CloseIcon, bD as DeleteIcon, co as AssignmentLateIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, bE as TextField, bH as DialogActions, aI as Menu, b2 as MenuItem, aG as useQueryClient, ax as useQuery, aH as useMutation, aq as Drawer, c6 as PersonIcon, cp as AccessTime, aM as CircularProgress, by as WarningIcon, cq as ChatIcon, cr as Send, cs as startOfWeek, ct as subWeeks, cu as endOfWeek, cv as addWeeks, cw as setMinutes, cx as setHours, cy as startOfDay, cz as ButtonGroup, cA as WeekIcon, cB as DayIcon, bP as y, b0 as FormControl, b_ as InputLabel, b1 as Select, bF as FormControlLabel, c2 as Switch, cC as LocalizationProvider, cD as AdapterDateFns, cE as DateTimePicker, cF as DatePicker, cG as TimePicker, bZ as InputAdornment, cH as isSameDay, cI as ContentCopyIcon, bB as Alert, b7 as Paper, cJ as ClearAllIcon, cK as eachDayOfInterval, cL as areIntervalsOverlapping, av as Badge, cM as InboxIcon, cN as MoreVert, cO as ChecklistIcon } from './vendor-Dx2XWalh.js';
import { c as apiRequest, i as isManager, g as getCurrentUser } from './main-Bqx8lZf7.js';
import { u as useRealtime } from './use-realtime-BuDcLGht.js';
...
const TIME_OFF_STATUS_CONFIG = {
  ...
  approved: { color: "#10B981", bgColor: "#DCFCE7", borderColor: "#A7F3D0", icon: CheckCircle, label: "Approved" },
...
function TradeBadge({ trade }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: label, arrow: true, placement: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 10 } }),
    isAccepted ? "Traded" : "Trading"
  ] }) });
}
function ShiftPill({ shift, onClick, trade, isSelectionMode, isSelected, isOvertime, onLogAdjustment }) {
...
⇄ Trade ${trade.status}` : ""}`,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1, minWidth: 0, display: "flex", alignItems: "center", height: "100%", gap: 0.5 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { component: "span", sx: { flex: 1, minWidth: 0, textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 0.5 }, children: [
                startStr,
                "-",
                endStr
              ] })
...
function WeeklyGridComponent({
  ...
  const shiftsByCell = React.useMemo(() => {
    const map = {};
    shifts.forEach((s) => {
      const key = `${s.userId}_${toDateStr$1(s.startTime)}`;
      if (!map[key]) map[key] = [];
      map[key].push(s);
    });
    return map;
  ...
  const shiftsByDate = React.useMemo(() => {
    const map = {};
    shifts.forEach((s) => {
      const key = toDateStr$1(s.startTime);
      if (!map[key]) map[key] = [];
      map[key].push(s);
    });
    return map;
  ...
  const overtimeShiftIds = React.useMemo(() => {
    ...
    Object.values(shiftsByEmp).forEach((empShifts) => {
      ...
      for (const s of empShifts) {
        const hrs = (new Date(s.endTime).getTime() - new Date(s.startTime).getTime()) / (1e3 * 60 * 60);
  ...
  const timeOffByCell = React.useMemo(() => {
    ...
    allVisibleTimeOff.forEach((r) => {
      const startD = toDate$2(r.startDate);
      const endD = toDate$2(r.endDate);
      let cur = startD;
      let safety = 0;
  ...
  const adjustmentsByCell = React.useMemo(() => {
    ...
    adjustmentLogs.forEach((l) => {
      ...
      const key = `${l.employeeId}_${toDateStr$1(l.startDate || l.date)}`;
      if (!map[key]) map[key] = [];
      map[key].push(l);
    });
    return map;
        ...
        Box,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 1.5, display: "flex", flexDirection: "column", gap: 1 }, children: [
              ...
              dayShifts.length === 0 && employees.every((emp) => (timeOffByCell[`${emp.id}_${dateStr}`] || []).length === 0) ? /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", sx: { textAlign: "center", py: 2, fontStyle: "italic" }, children: "No shifts scheduled" }) : dayShifts.map((shift) => {
                  ...
                  Box,
                  {
                    ...
                    children: [
                      trade && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 10, color: trade.status === "accepted" ? "#3B82F6" : "#8B5CF6" } }),
...
const EmployeeRow = React.memo(({
  ...
  const weekHours = weekDays.reduce((sum, date, dayIndex) => {
  ...
  if (prevProps.selectedShifts !== nextProps.selectedShifts) {
    for (const shifts of Object.values(prevProps.empShifts)) {
  ...
  if (prevProps.selectedLogs !== nextProps.selectedLogs) {
    for (const logs of Object.values(prevProps.empAdjustments)) {
      for (const l of logs) {
...
const WeeklyGrid = React.memo(WeeklyGridComponent, (prevProps, nextProps) => {
  return prevProps.weekStart.getTime() === nextProps.weekStart.getTime() && prevProps.shifts === nextProps.shifts && prevProps.employees === nextProps.employees && prevProps.timeOffRequests === nextProps.timeOffRequests && prevProps.adjustmentLogs === nextProps.adjustmentLogs && prevProps.holidays === nextProps.holidays && prevProps.shiftTrades === nextProps.shiftTrades && prevProps.isManager === nextProps.isManager && prevProps.isSelectionMode === nextProps.isSelectionMode && prevProps.selectedShifts === nextProps.selectedShifts && prevProps.selectedLogs === nextProps.selectedLogs;
});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    ...
    myTimeOff.map((req) => {
      const statusConfig = {
        ...
        approved: { bg: "#DCFCE7", border: "#A7F3D0", color: "#166534", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 16, color: "#10B981" } }), label: "Approved" },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 0.5 }, children: [
                trade && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Chip,
                  {
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 14, color: "inherit" } }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
      ...
      activeTrades.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Chip,
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 14 } }),
    ...
    dayTimeOff.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { display: "flex", flexDirection: "column", gap: 1, mb: 2 }, children: dayTimeOff.map((req) => {
      ...
      const statusConfig = {
        ...
        approved: { bg: "#DCFCE7", border: "#A7F3D0", color: "#166534", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { sx: { fontSize: 18, color: "#10B981" } }), label: req.isPaid ? "Approved (Paid)" : "Approved (Unpaid)" },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1, minWidth: 0 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }, children: [
                ...
                trade && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Chip,
                  {
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 12 } }),
                    label: trade.status === "accepted" ? "Traded" : "Trade Pending",
                    size: "small",
                    sx: {
                      height: 20,
...
function RequestsPanel({
  ...
  const [rejectPaymentStatus, setRejectPaymentStatus] = reactExports.useState("unpaid");
  ...
  const scheduleAlerts = React.useMemo(() => {
    ...
    Object.keys(shiftsByEmp).forEach((userId) => {
      ...
      for (let i = 0; i < empShifts.length - 1; i++) {
        if (new Date(empShifts[i].endTime) > new Date(empShifts[i + 1].startTime)) {
          alerts.push({ type: "error", message: `${empName} has overlapping shifts on ${safeFormat$1(empShifts[i].startTime, "MMM d")}.` });
          break;
        }
      }
    });
    ...
    shiftTrades.filter((t) => t.status === "pending" && !(t.shift?.startTime && new Date(t.shift.startTime) < now)).forEach((trade) => {
      const created = new Date(trade.createdAt || /* @__PURE__ */ new Date());
  ...
  const handleConfirmApprove = (leavePaymentStatus) => {
    if (approvingId) {
  ...
  const pendingTrades = shiftTrades.filter((t) => {
    ...
    if (t.shift?.startTime && new Date(t.shift.startTime) < /* @__PURE__ */ new Date()) return false;
    return true;
  });
  [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", flexDirection: "column", gap: 3 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Accordion,
        {
          ...
          children: [
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { spacing: 1.5, children: pendingTimeOff.map((req) => {
              const reqStart = new Date(req.startDate);
              reqStart.setHours(0, 0, 0, 0);
              const now = /* @__PURE__ */ new Date();
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { py: 1.5, px: 2, "&:last-child": { pb: 1.5 } }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1 }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 0.5 }, children: [
                        isOverdue && /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: "Overdue", size: "small", color: "error", variant: "outlined", sx: { height: 20, fontSize: "0.6rem" } }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AccordionSummary,
              {
                ...
                sx: { px: 0, minHeight: 48, "& .MuiAccordionSummary-content": { my: 0 } },
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 20, color: "#8B5CF6" } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionDetails, { sx: { px: 0, pt: 0, pb: 2 }, children: [
              ...
              pendingTrades.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { fontSize: 28, color: isDark ? alpha("#8B5CF6", 0.25) : alpha("#5B21B6", 0.15) } }),
                  ...
                  Card,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { py: 1.5, px: 2, "&:last-child": { pb: 1.5 } }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 1, mt: 1.5, flexWrap: "wrap" }, children: [
                        ...
                        isOpenTrade && isPending && !isRequester && !isManager && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            size: "small",
                            variant: "contained",
                        ...
                        isOpenTrade && isPending && isManager && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            size: "small",
                            variant: "outlined",
      ...
      isManager && scheduleAlerts?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, { sx: { borderColor: isDark ? "#3D3228" : "#E8E0D4" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Accordion,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionDetails, { sx: { px: 0, pt: 0, pb: 2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { spacing: 1, children: scheduleAlerts.map((alert, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: {
                p: 1.5,
                borderRadius: 2,
              ...
              }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "caption", color: alert.type === "error" ? "error.dark" : "warning.dark", fontWeight: 600, children: [
                alert.type === "error" ? "🔴 " : "🟡 ",
                " ",
                alert.message
              ] }) }, i)) }) })
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mt: 2 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", fontWeight: 700, color: "text.secondary", sx: { mb: 1, display: "block", textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Pay Treatment" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", sx: { mt: 0.5, display: "block" }, children: rejectPaymentStatus === "awol" ? "Absence Without Official Leave — affects disciplinary record" : "Leave Without Pay (LWOP) — standard absence" })
            ] })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Menu,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { onClick: () => handleConfirmApprove("paid"), sx: { py: 1.5, display: "flex", flexDirection: "column", alignItems: "flex-start" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 700, color: "success.main", children: "Approve as Paid Leave ✓" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "Deducts from Leave Balance — Employee gets full pay" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, { sx: { my: 0.5 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { onClick: () => handleConfirmApprove("unpaid"), sx: { py: 1.5, display: "flex", flexDirection: "column", alignItems: "flex-start" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 700, color: "warning.main", children: "Approve as Unpaid Leave" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "Leave Without Pay (LWOP) — No pay for absent days" })
          ] })
        ]
      }
    )
          ...
          canRespond && !showDisputeInput && /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1.5, sx: { mb: 2.5 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                variant: "contained",
                color: "success",
                startIcon: verifyMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircularProgress, { size: 16, color: "inherit" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, {}),
...
function ScheduleV2() {
  ...
  const [bulkExceptionPreview, setBulkExceptionPreview] = reactExports.useState(null);
  const [bulkDeleteState, setBulkDeleteState] = reactExports.useState({
    isOpen: false,
    target: "shifts",
    employeeId: "all",
  ...
  const [bulkCreatePreview, setBulkCreatePreview] = reactExports.useState(null);
  ...
  const [newShift, setNewShift] = reactExports.useState({
    employeeId: "",
    startTime: null,
    endTime: null,
    notes: "",
  ...
  const [editForm, setEditForm] = reactExports.useState({ startTime: null, endTime: null, notes: "", breakDurationMinutes: 30 });
  ...
  const bulkCreateMutation = useMutation({
    mutationFn: async (payload) => {
      ...
      if (!res.ok) {
        const err = await res.json();
        throw new Error(err.message || "Failed to bulk create");
      }
      return res.json();
    },
    onSuccess: (data, variables) => {
      if (data.preview) {
        ...
        queryClient.invalidateQueries({ queryKey: ["shifts", "branch"] });
        y.success(`Created ${data.createdShifts} shifts. Skipped ${data.skipped}.`);
        setCreateModalOpen(false);
  ...
  const approveTimeOffMutation = useMutation({
    mutationFn: async ({ id, status, rejectionReason, leavePaymentStatus }) => {
      const endpoint = status === "approved" ? `/api/time-off-requests/${id}/approve` : `/api/time-off-requests/${id}/reject`;
      const body = status === "rejected" ? { status, rejectionReason, leavePaymentStatus: leavePaymentStatus || "unpaid" } : { status, leavePaymentStatus: leavePaymentStatus || "paid" };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1, display: "flex", flexDirection: "column", height: "100%", minHeight: "100%", bgcolor: "transparent" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", flexWrap: "wrap", gap: 1 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(ButtonGroup, { size: "small", variant: "outlined", sx: { height: 32, display: { xs: "none", sm: "flex" } }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Add a new shift", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => {
                  setNewShift((prev) => ({ ...prev, employeeId: "", startTime: null, endTime: null, notes: "" }));
                  setCreateModalOpen(true);
                },
                sx: {
                  textTransform: "none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Menu,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { onClick: () => {
                  setActionsMenuAnchor(null);
                  setBulkDeleteState((prev) => ({ ...prev, isOpen: true }));
                }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DeleteIcon, { sx: { mr: 1.5, fontSize: 18, color: "#DC2626" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 600, children: "Bulk Delete (Range)" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { onClick: () => {
                  setActionsMenuAnchor(null);
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { onClick: () => {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, { sx: { mr: 1.5, fontSize: 18, color: "#8B5CF6" } }),
        ...
        !isManager$1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(ButtonGroup, { size: "small", variant: "outlined", sx: { height: 32 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Request Time Off", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "small",
              variant: "outlined",
              startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(VacationIcon, {}),
              ...
              children: isMobile ? "" : "Time Off"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Trade a Shift", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "small",
              variant: "outlined",
              startIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, {}),
              onClick: () => {
                const myFutureShifts = shifts.filter((s) => s.userId === currentUser?.id && new Date(s.startTime) > /* @__PURE__ */ new Date());
                if (myFutureShifts.length === 0) {
                  y.info("No future shifts to trade");
    ...
    isMobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Trade Shift", placement: "left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconButton,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwapIcon, {})
        }
      ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: createModalOpen, onClose: () => setCreateModalOpen(false), maxWidth: "sm", fullWidth: true, fullScreen: isMobile, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 3, sx: { mt: 1 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FormControlLabel,
          {
            control: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: newShift.isBulk, onChange: (e) => setNewShift((p) => ({ ...p, isBulk: e.target.checked })) }),
            label: "Schedule multiple days (Recurring)"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: !newShift.isBulk ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            DateTimePicker,
            {
              label: "Start Time",
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2, sx: { p: 2, bgcolor: "background.paper", border: "1px solid", borderColor: "divider", borderRadius: 2 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", children: "Date Range" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { label: "Start Date", value: newShift.bulkStartDate, onChange: (val) => setNewShift((p) => ({ ...p, bulkStartDate: val })), slotProps: { textField: { fullWidth: true } } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { label: "End Date", value: newShift.bulkEndDate, onChange: (val) => setNewShift((p) => ({ ...p, bulkEndDate: val })), slotProps: { textField: { fullWidth: true } }, minDate: newShift.bulkStartDate || void 0 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", sx: { mt: 1 }, children: "Weekly Schedule" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", spacing: 1, flexWrap: "wrap", children: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Chip,
            {
              label: day,
              clickable: true,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", sx: { mt: 1 }, children: "Work Hours" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 2, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimePicker, { label: "Start Time", value: newShift.bulkStartTime, onChange: (val) => setNewShift((p) => ({ ...p, bulkStartTime: val })), slotProps: { textField: { fullWidth: true } } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimePicker, { label: "End Time", value: newShift.bulkEndTime, onChange: (val) => setNewShift((p) => ({ ...p, bulkEndTime: val })), slotProps: { textField: { fullWidth: true } } })
          ] })
        ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextField,
          {
            ...
            InputProps: { inputProps: { min: 0, max: 120, step: 5 }, endAdornment: /* @__PURE__ */ jsxRuntimeExports.jsx(InputAdornment, { position: "end", children: "min" }) },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            onClick: () => {
              if (newShift.isBulk) {
                if (!newShift.bulkStartDate || !newShift.bulkEndDate || !newShift.bulkStartTime || !newShift.bulkEndTime || !newShift.bulkDays.length) {
                  y.error("Please fill in all bulk scheduling details");
                  return;
                }
            ...
            children: createShiftMutation.isPending || bulkCreateMutation.isPending ? "Processing..." : "Create"
          }
        )
      ] })
    ] }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { component: "div", sx: { pb: 1 }, children: [
            ...
            !editAdjId && /* @__PURE__ */ jsxRuntimeExports.jsx(Stack, { direction: "row", spacing: 1, flexWrap: "wrap", sx: { mt: 1.5 }, children: quickAdjustmentTypes.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Chip,
              {
                ...
                clickable: true,
                onClick: () => {
                  setAdjType(option.value);
                  if (option.value === "absent") setAdjValue("1");
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2.5, sx: { mt: 1 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Select,
                {
                  ...
                  onChange: (e) => {
                    ...
                    if (e.target.value === "absent") setAdjValue("1");
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField,
              {
                label: adjType === "late" || adjType === "undertime" || adjType === "overtime" ? "Minutes" : adjType === "absent" ? "Days" : "Hours",
                type: "number",
                size: "small",
                fullWidth: true,
                value: adjType === "absent" ? "1" : adjValue,
                onChange: (e) => {
                  if (adjType !== "absent") setAdjValue(e.target.value);
                },
                InputProps: {
                  readOnly: adjType === "absent",
                  endAdornment: /* @__PURE__ */ jsxRuntimeExports.jsx(InputAdornment, { position: "end", children: adjType === "late" || adjType === "undertime" || adjType === "overtime" ? "mins" : adjType === "absent" ? "day" : "hrs" })
                },
                helperText: adjType === "late" || adjType === "undertime" || adjType === "overtime" ? `Use minutes for ${adjType === "overtime" ? "overtime" : "tardiness or undertime"} from the logbook.` : adjType === "absent" ? "Absent records are exactly 1 day per scheduled shift." : "Use hours for legacy logs."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: bulkDeleteState.isOpen, onClose: () => setBulkDeleteState({ ...bulkDeleteState, isOpen: false, preview: null }), maxWidth: "sm", fullWidth: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { sx: { fontWeight: 800, color: "error.main" }, children: "Bulk Delete Options" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2.5, sx: { mt: 1 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "Delete multiple shifts or exception logs at once by selecting a date range." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(FormControl, { fullWidth: true, size: "small", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { children: "Delete Target" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: bulkDeleteState.target, label: "Delete Target", onChange: (e) => setBulkDeleteState({ ...bulkDeleteState, target: e.target.value }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "shifts", children: "Shifts Only" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "exceptions", children: "Exception Logs Only" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "both", children: "Both Shifts & Exceptions" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(FormControl, { fullWidth: true, size: "small", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { children: "Employee" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: bulkDeleteState.employeeId, label: "Employee", onChange: (e) => setBulkDeleteState({ ...bulkDeleteState, employeeId: e.target.value }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { value: "all", children: "All Employees" }),
            employees.map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(MenuItem, { value: emp.id, children: [
              emp.firstName,
              " ",
              emp.lastName
            ] }, emp.id))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { direction: "row", spacing: 1, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { label: "Start Date", value: bulkDeleteState.startDate, onChange: (v) => setBulkDeleteState({ ...bulkDeleteState, startDate: v || /* @__PURE__ */ new Date() }), slotProps: { textField: { size: "small", fullWidth: true } } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { label: "End Date", value: bulkDeleteState.endDate, onChange: (v) => setBulkDeleteState({ ...bulkDeleteState, endDate: v || /* @__PURE__ */ new Date() }), minDate: bulkDeleteState.startDate, slotProps: { textField: { size: "small", fullWidth: true } } })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextField,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2, bgcolor: "background.default", borderRadius: 1, border: "1px solid", borderColor: "divider" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", sx: { mb: 1 }, children: "Pre-flight Impact Summary" }),
          bulkDeleteState.isLoadingPreview ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircularProgress, { size: 20 }) : bulkDeleteState.preview ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 1, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", children: [
              "• ",
              bulkDeleteState.preview.shiftCount,
              " shifts will be deleted."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", children: [
              "• ",
              bulkDeleteState.preview.exceptionCount,
              " exception logs will be deleted."
            ] }),
            bulkDeleteState.preview.tradesCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "error.main", children: [
              "• ",
              bulkDeleteState.preview.tradesCount,
              " shift trades will be canceled."
            ] }),
            bulkDeleteState.preview.orphanedLeaves?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { mt: 1 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "warning.main", fontWeight: 600, children: "The following leave requests will be orphaned:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { margin: 0, paddingLeft: "20px" }, children: bulkDeleteState.preview.orphanedLeaves.map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "text.secondary", children: [
                l.employeeName,
                "'s ",
                l.type,
                " leave (",
                safeFormat(new Date(l.start), "MMM d"),
                ")"
              ] }) }, i)) })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", children: "Select options to see impact." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { severity: "warning", sx: { "& .MuiAlert-message": { width: "100%" } }, children: [
          "This action is permanent and cannot be undone. To proceed, type ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setBulkDeleteState({ ...bulkDeleteState, isOpen: false }), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "contained",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Dialog,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { sx: { fontWeight: 800, display: "flex", alignItems: "center", gap: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { component: "span", sx: { fontSize: "1.2rem" }, children: "📋" }),
            " Bulk Action Summary"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: bulkExceptionPreview && /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2.5, sx: { mt: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "info", sx: { borderRadius: 2 }, children: "Review the following changes before proceeding. This will create multiple exception logs at once." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { p: 2.5, bgcolor: isDark ? alpha("#F59E0B", 0.08) : alpha("#F59E0B", 0.05), border: "1px solid", borderColor: isDark ? alpha("#F59E0B", 0.2) : alpha("#F59E0B", 0.15), borderRadius: 2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 1.5, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", fontWeight: 700, children: "Employee" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 600, children: bulkExceptionPreview.employeeName })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", fontWeight: 700, children: "Exception Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: bulkExceptionPreview.type, size: "small", color: "warning", variant: "outlined" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", fontWeight: 700, children: "Value" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", fontWeight: 600, children: bulkExceptionPreview.value })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", fontWeight: 700, children: "Date Range" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", fontWeight: 600, children: [
                  bulkExceptionPreview.startDate,
                  " – ",
                  bulkExceptionPreview.endDate
                ] })
              ] }),
              bulkExceptionPreview.remarks && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", fontWeight: 700, children: "Remarks" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", sx: { maxWidth: "60%", textAlign: "right" }, children: bulkExceptionPreview.remarks })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2, bgcolor: isDark ? "#2A2018" : "#F8F5F0", borderRadius: 2, border: "1px solid", borderColor: "divider" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "h6", fontWeight: 800, color: "warning.main", sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { component: "span", sx: { fontSize: "1.4rem" }, children: "⚡" }),
                bulkExceptionPreview.dateCount,
                " exception log",
                bulkExceptionPreview.dateCount > 1 ? "s" : "",
                " will be created"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "text.secondary", sx: { mt: 0.5 }, children: [
                "One ",
                bulkExceptionPreview.type.toLowerCase(),
                " entry per day for ",
                bulkExceptionPreview.employeeName,
                " from ",
                bulkExceptionPreview.startDate,
                " to ",
                bulkExceptionPreview.endDate,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: async () => {
                  ...
                  queryClient.invalidateQueries({ queryKey: [isManager$1 ? "adjustment-logs-branch" : "adjustment-logs-mine"] });
                  if (failCount === 0) {
                    y.success(`${successCount} exception log${successCount > 1 ? "s" : ""} created successfully`);
                  } else {
                    y.warning(`${successCount} logged, ${failCount} failed out of ${datesToLog.length} days`);
                  }
                ...
                children: bulkExceptionPreview?.isProcessing ? "Creating..." : `Confirm & Create ${bulkExceptionPreview?.dateCount || 0} Logs`
              }
            )
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Dialog,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: bulkCreatePreview && /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 2.5, sx: { mt: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "info", sx: { borderRadius: 2 }, children: "Review the scheduled shifts before proceeding. Overlapping shifts or time-off are automatically skipped." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2, bgcolor: isDark ? "#2A2018" : "#F8F5F0", borderRadius: 2, border: "1px solid", borderColor: "divider" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "h6", fontWeight: 800, color: "primary.main", sx: { display: "flex", alignItems: "center", gap: 1 }, children: [
                bulkCreatePreview.data.createCount,
                " shift",
                bulkCreatePreview.data.createCount !== 1 ? "s" : "",
                " will be created"
              ] }),
              bulkCreatePreview.data.skipCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "warning.main", sx: { mt: 1, fontWeight: 700 }, children: [
                bulkCreatePreview.data.skipCount,
                " shift",
                bulkCreatePreview.data.skipCount !== 1 ? "s" : "",
                " will be skipped due to conflicts."
              ] }),
              bulkCreatePreview.data.skippedDetails?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { margin: "8px 0 0 0", paddingLeft: "20px" }, children: bulkCreatePreview.data.skippedDetails.map((skip, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "caption", color: "text.secondary", children: [
                safeFormat(new Date(skip.date), "MMM d, yyyy"),
                ": ",
                skip.reason
              ] }) }, i)) })
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogActions, { sx: { px: 3, pb: 2 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: bulkCreateMutation.isPending ? "Creating..." : `Confirm & Create`
              }
            )
          ] })
        ]
