const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HolidayCalendarView-4Q1itR3a.js","assets/vendor-BZHHI3oX.js","assets/vendor-Bi9pq-j3.css","assets/vendor-calendar-CxNXhoCY.js"])))=>i.map(i=>d[i]);
import { a0 as useTheme, aG as useQueryClient, r as reactExports, bl as format, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, an as Tooltip, X as Box, ag as alpha, aj as Typography, aM as CircularProgress, a3 as CalendarIcon, aJ as Stack, bE as TextField, b2 as MenuItem, aK as Button, cP as RefreshIcon, bp as AddIcon, cQ as LinearProgress, bs as Card, bt as CardContent, c4 as Tabs, c5 as Tab, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, am as Chip, aU as CheckCircle, cn as Block, af as IconButton, bV as EditIcon, bD as DeleteIcon, bz as CloseIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, cC as LocalizationProvider, cD as AdapterDateFns, cF as DatePicker, bF as FormControlLabel, c2 as Switch, bH as DialogActions, bB as Alert, T as __vitePreload } from './vendor-BZHHI3oX.js';
import { u as useRealtime } from './use-realtime-Cix389so.js';
import { u as useAuth, c as apiRequest } from './main-ktqtsBlx.js';
import { u as useToast } from './use-toast-CI81V-xA.js';

const HolidayCalendarView = reactExports.lazy(() => __vitePreload(() => import('./HolidayCalendarView-4Q1itR3a.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0));
const holidayTypes = [
