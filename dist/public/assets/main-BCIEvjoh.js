...
const MuiDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-dashboard-CAY9FVMJ.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0));
const MuiEmployees = reactExports.lazy(() => __vitePreload(() => import('./mui-employees-WnrLpISu.js'),true              ?__vite__mapDeps([6,1,2,7,3,4,8,9,10,11,12]):void 0));
const ScheduleV2 = reactExports.lazy(() => __vitePreload(() => import('./schedule-v2-CID19L0B.js'),true              ?__vite__mapDeps([13,1,2,7]):void 0));
const MuiPayroll = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-CALO-INx.js'),true              ?__vite__mapDeps([14,1,2,7,15]):void 0));
const MuiNotifications = reactExports.lazy(() => __vitePreload(() => import('./mui-notifications-QLqNyJPz.js'),true              ?__vite__mapDeps([16,1,2,3,7]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-shift-trading-BLGjTUTL.js'),true              ?__vite__mapDeps([17,1,2,3,7,18]):void 0));
const MuiBranches = reactExports.lazy(() => __vitePreload(() => import('./mui-branches-tj1Dphbp.js'),true              ?__vite__mapDeps([5,1,2,3]):void 0));
const MuiReports = reactExports.lazy(() => __vitePreload(() => import('./mui-reports-CTRZWEMf.js'),true              ?__vite__mapDeps([19,1,2]):void 0));
const MuiAnalytics = reactExports.lazy(() => __vitePreload(() => import('./mui-analytics-D48j-VGx.js'),true              ?__vite__mapDeps([20,1,2,7,21]):void 0));
const MuiLogin = reactExports.lazy(() => __vitePreload(() => import('./mui-login-CFOAVoIV.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0));
reactExports.lazy(() => __vitePreload(() => import('./mui-time-off-CfozoQrK.js'),true              ?__vite__mapDeps([23,1,2,3,7]):void 0));
const MuiDeductionSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-deduction-settings-DkFlaI2X.js'),true              ?__vite__mapDeps([24,1,2]):void 0));
const MuiPayrollManagement = reactExports.lazy(() => __vitePreload(() => import('./mui-payroll-management-BQdIP7V7.js'),true              ?__vite__mapDeps([25,1,2,3,7,26,15,12,9]):void 0));
const MuiAdminDeductionRates = reactExports.lazy(() => __vitePreload(() => import('./mui-admin-deduction-rates-BPBRUI1k.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0));
const MuiAuditLogs = reactExports.lazy(() => __vitePreload(() => import('./mui-audit-logs-CO-w4-c2.js'),true              ?__vite__mapDeps([28,1,2,7]):void 0));
const MuiHolidayCalendar = reactExports.lazy(() => __vitePreload(() => import('./mui-holiday-calendar-PH5lTS7I.js'),true              ?__vite__mapDeps([29,1,2,3]):void 0));
const MuiComplianceDashboard = reactExports.lazy(() => __vitePreload(() => import('./mui-compliance-dashboard-DpUnwzxe.js'),true              ?__vite__mapDeps([30,1,2]):void 0));
const MuiProfileSettings = reactExports.lazy(() => __vitePreload(() => import('./mui-profile-settings-B0gYHT2n.js'),true              ?__vite__mapDeps([31,1,2,8,9,10,3]):void 0));
const MuiCompanySettings = reactExports.lazy(() => __vitePreload(() => import('./mui-company-settings-hbLgEl32.js'),true              ?__vite__mapDeps([32,1,2,3,10]):void 0));
const Mui13thMonth = reactExports.lazy(() => __vitePreload(() => import('./mui-13th-month-DDyP2d8W.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0));
const MuiLeaveCredits = reactExports.lazy(() => __vitePreload(() => import('./mui-leave-credits-1TCZhDMH.js'),true              ?__vite__mapDeps([34,1,2,3,4]):void 0));
const MuiRequests = reactExports.lazy(() => __vitePreload(() => import('./mui-requests-D5EURm8H.js'),true              ?__vite__mapDeps([35,1,2,23,3,7]):void 0));
const MobileRequests = reactExports.lazy(() => __vitePreload(() => import('./mobile-requests-BHybEV_4.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0));
const MobileMore = reactExports.lazy(() => __vitePreload(() => import('./mobile-more-XHk36QbZ.js'),true              ?__vite__mapDeps([37,1,2]):void 0));
const Setup = reactExports.lazy(() => __vitePreload(() => import('./setup-CTxJk9ad.js'),true              ?__vite__mapDeps([38,1,2,11,9,3]):void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import('./not-found-BjJUEhNl.js'),true              ?__vite__mapDeps([39,1,2,9]):void 0));
const prefetchRoutes = () => {
  const idleCallback = typeof requestIdleCallback !== "undefined" ? requestIdleCallback : setTimeout;
  idleCallback(() => {
    __vitePreload(() => import('./mui-dashboard-CAY9FVMJ.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0);
    __vitePreload(() => import('./schedule-v2-CID19L0B.js'),true              ?__vite__mapDeps([13,1,2,7]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-employees-WnrLpISu.js'),true              ?__vite__mapDeps([6,1,2,7,3,4,8,9,10,11,12]):void 0);
    __vitePreload(() => import('./mui-payroll-management-BQdIP7V7.js'),true              ?__vite__mapDeps([25,1,2,3,7,26,15,12,9]):void 0);
    __vitePreload(() => import('./mui-notifications-QLqNyJPz.js'),true              ?__vite__mapDeps([16,1,2,3,7]):void 0);
  });
  idleCallback(() => {
    __vitePreload(() => import('./mui-reports-CTRZWEMf.js'),true              ?__vite__mapDeps([19,1,2]):void 0);
    __vitePreload(() => import('./mui-requests-D5EURm8H.js'),true              ?__vite__mapDeps([35,1,2,23,3,7]):void 0);
    __vitePreload(() => import('./mui-profile-settings-B0gYHT2n.js'),true              ?__vite__mapDeps([31,1,2,8,9,10,3]):void 0);
    __vitePreload(() => import('./mobile-requests-BHybEV_4.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0);
  });
};
