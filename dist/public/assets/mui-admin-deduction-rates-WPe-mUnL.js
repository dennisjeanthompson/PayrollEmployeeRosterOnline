const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/sss-contribution-table-DS10Njur.js","assets/vendor-Br1LjuIs.js","assets/vendor-Bi9pq-j3.css"])))=>i.map(i=>d[i]);
import { a0 as useTheme, aG as useQueryClient, r as reactExports, ax as useQuery, aH as useMutation, Q as jsxRuntimeExports, X as Box, aM as CircularProgress, ag as alpha, aj as Typography, aJ as Stack, aK as Button, cP as RefreshIcon, bp as AddIcon, c8 as SecurityIcon, c9 as HealthIcon, ca as HomeIcon, bv as TaxIcon, cQ as LinearProgress, ci as Accordion, cj as AccordionSummary, am as Chip, ck as ExpandMore, cl as AccordionDetails, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody, an as Tooltip, af as IconButton, bV as EditIcon, bD as DeleteIcon, ay as Dialog, bx as DialogTitle, bA as DialogContent, bE as TextField, b2 as MenuItem, bH as DialogActions, T as __vitePreload } from './vendor-Br1LjuIs.js';
import { P as PesoIcon, c as apiRequest } from './main-DtyG-vBp.js';
import { u as useToast } from './use-toast-D9VL1-uB.js';

const SSSContributionTable = reactExports.lazy(() => __vitePreload(() => import('./sss-contribution-table-DS10Njur.js'),true              ?__vite__mapDeps([0,1,2]):void 0));
