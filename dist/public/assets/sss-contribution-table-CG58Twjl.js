import { a0 as useTheme, r as reactExports, Q as jsxRuntimeExports, bs as Card, ag as alpha, bt as CardContent, X as Box, aJ as Stack, aj as Typography, am as Chip, b7 as Paper, bE as TextField, bZ as InputAdornment, bB as Alert, cR as TableContainer, cS as Table, cT as TableHead, cU as TableRow, cV as TableCell, cW as TableBody } from './vendor-BZHHI3oX.js';

const sss2026Brackets = [
    ...
    Card,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { p: 0 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableContainer, { sx: { maxHeight: 600 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { stickyHeader: true, size: "small", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: sss2026Brackets.map((bracket, index) => {
