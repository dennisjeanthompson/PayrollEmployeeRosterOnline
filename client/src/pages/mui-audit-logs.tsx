...
const actionLabels: Record<string, string> = {
  ...
  trade_request: "Trade Requested",
  trade_take: "Trade Taken",
  ...
  time_off_update: "Time Off Updated",
  shift_bulk_create: "Shifts Bulk Created",
  shift_bulk_delete: "Shifts Bulk Deleted",
  deduction_settings_update: "Deduction Settings Updated",
  payroll_period_create: "Payroll Period Created",
  payroll_period_delete: "Payroll Period Deleted",
  payroll_period_archive: "Payroll Period Archived",
...
const actionColors: Record<string, "success" | "warning" | "error" | "info" | "default" | "primary" | "secondary"> = {
  ...
  time_off_update: "warning",
  shift_bulk_create: "success",
  shift_bulk_delete: "error",
  deduction_settings_update: "warning",
  payroll_period_create: "success",
  payroll_period_delete: "error",
  payroll_period_archive: "info",
