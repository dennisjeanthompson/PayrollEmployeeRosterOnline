...
export default function MuiLogin() {
  ...
  const handleDemoLogin = (usernameStr: string, passwordStr: string) => {
    ...
    startTransition(() => {
      ...
      // Call handleSubmit with these specific values directly since state updates are async
      setIsLoading(true);
      setError(null);
          ...
          >
            <CardContent sx={{ p: 4 }}>
              ...
              <Box sx={{ position: 'relative', my: 3 }}>
                <Box sx={{ position: 'absolute', top: '50%', left: 0, right: 0, borderTop: `1px solid ${theme.palette.divider}` }} />
                <Typography variant="body2" sx={{ position: 'relative', display: 'inline-block', bgcolor: 'background.paper', px: 2, left: '50%', transform: 'translateX(-50%)', color: 'text.secondary' }}>
