...
async function updateLoans() {
  ...
  try {
    ...
    await sql`
      ...
      SET "total_amount" = '7272.00', "remaining_balance" = '7272.00', "monthly_amortization" = '303.00', "status" = 'pending'
    ...
    await sql`
      UPDATE loan_requests
      SET "total_amount" = '15000.00', "remaining_balance" = '15000.00', "monthly_amortization" = '300.00', "status" = 'pending'
