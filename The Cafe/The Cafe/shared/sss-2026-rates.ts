/**
 * 2026 SSS Contribution Table Seed Data
 * Based on SSS Circular effective January 2026
 * 
 * Rate: 15% total (10% Employer, 5% Employee for Regular SS)
 * MSC Range: ₱5,000 - ₱35,000
 * Total brackets: 61
 * 
 * Note: The SSS contribution table structure remains the same for 2026.
 * The 15% total rate (5% EE / 10% ER) continues from 2025.
...
// Official 2026 SSS Contribution Table (61 brackets)
// Same structure as 2025 — the 15% rate has been in effect since Jan 2025
export const sss2026Brackets: SSSBracket[] = [
