                  ...
                  dayShifts.map(shift => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Avatar sx={{ width: 36, height: 36, bgcolor: rc.bg, color: rc.text, fontSize: '0.75rem', fontWeight: 700 }}>
              ...
              >
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Avatar sx={{ width: 32, height: 32, bgcolor: rc.bg, color: rc.text, fontSize: '0.72rem', fontWeight: 700 }}>
                      {emp.firstName[0]}{emp.lastName[0]}
                    </Avatar>
                    <Box sx={{ minWidth: 0 }}>
